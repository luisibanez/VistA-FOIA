SROATM1 ;BIR/MAM - NON CARDIAC TRANSMISSION ; [ 04/07/04  2:12 PM ]
 ;;3.0; Surgery ;**27,38,47,60,62,81,88,93,95,125**;24 Jun 93
 ;
 ...
 S NYUK=$P(SRA(200),"^",49) D ONE S SHEMP=SHEMP_MOE,NYUK=$P(SRA(200),"^",50) D ONE S SHEMP=SHEMP_MOE,NYUK=$P(SRA(200),"^",51),SHEMP=SHEMP_$J(NYUK,2)
