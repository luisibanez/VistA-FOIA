SROCL1 ;BIR/SJA - LOAD CARDIAC LAB DATA ; [ 07/23/04  2:34 PM ]
 ;;3.0; Surgery ;**95,125**;24 Jun 93
 ;
...
START S SRALR=$S($D(^DPT($P(^SRF(SRTN,0),"^"),"LR")):$P(^("LR"),"^"),1:"")
 ...
 S SRST=9999999-SRAOP,X1=SRAOP,X2=-90 D C^%DTC S SREND0=9999999-X
...
SRAT ; Get test and data name(s) for test from file 139.2.
 ...
 F SRAT=1,5,7,11,14,21:1:24 S SREND=$S("117"[SRAT:SREND1,1:SREND0) D SP^SROAL1
