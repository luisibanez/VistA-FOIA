SROAPCA3 ;B'HAM ISC/MAM - CARDIAC OCCURRENCE DATA ; [ 05/19/04  9:12 AM ]
 ;;3.0; Surgery ;**38,71,95,101,125**;24 Jun 93
 ...
 W !,?2,"Endocarditis:",?36,$P(SRAO(4),"^"),?42,"Trachestomy:",?74,$P(SRAO(14),"^")
