SROACL1 ;B'HAM ISC/MAM - CARDIAC PREOP CLINICAL DATA ; [ 06/22/04  08:19 AM ]
 ;;3.0; Surgery ;**38,71,95,125**;24 Jun 93
 F I=0,200,202,205,206,206.1,208,209 S SRA(I)=$G(^SRF(SRTN,I))
 S NYUK=$P(SRA(206),"^") S:NYUK'="" NYUK=$S(NYUK["C":+NYUK_" cm",+NYUK=NYUK:+NYUK_" in",NYUK="NS":" NS",1:NYUK) S SRAO(1)=NYUK_"^236"
 S NYUK=$P(SRA(206),"^",2) S:NYUK'="" NYUK=$S(NYUK["K":+NYUK_" kg",+NYUK=NYUK:+NYUK_" lb",NYUK="NS":" NS",1:NYUK) S SRAO(2)=NYUK_"^237"
