SROALEN ;B'HAM ISC/MAM - LAB INFO ; [ 04/13/04  2:17 PM ]
 ;;3.0; Surgery ;**38,100,125**;24 Jun 93
...
HELP W @IOF,!!!!,"Enter the number or range of numbers you want to edit.  Examples of proper",!,"responses are listed below."
 W !!,"1. Enter 'A' to update all information.",!!,"2. Enter a number (1-13) to update the information in that field.  (For",!,"   example, enter '2' to update Preoperative BUN)"
 W !!,"3. Enter a range of numbers (1-13) separated by a ':' to enter a range of",!,"   information.  (For example, enter '1:3' to update Serum Sodium,",!,"   BUN, and Serum Creatinine)"
...
RANGE ; range of numbers
 ...
 Q
ONE ; edit one item
 I EMILY>13 K DR,DIE S DA=SRTN,DR=$P(SRAO(EMILY),"^",4)_"T;"_$P(SRAO(EMILY),"^",5)_"T;"_$P(SRAO(EMILY),"^",6)_"T",DIE=130 D ^DIE S:$D(Y) SRNOMORE=1 K DR Q
