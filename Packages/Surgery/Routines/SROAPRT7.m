SROAPRT7 ;B'HAM ISC/MAM - PRINT OCCURRENCES ; [ 06/17/04  9:25 AM ]
 ;;3.0; Surgery ;**38,47,57,60,125**;24 Jun 93
 ...
 S NYUK=$P(SRA(205),"^",37) D YN S SRAO("6E")=SHEMP_"^488",NYUK=$P(SRA(205),"^",8) D YN S SRAO("1C")=SHEMP_"^404"
 ...
 .I $E(Y)="6" S SRI=$S(Y="6A":15,Y="6B":19,Y="6C":20,Y="6D":3,Y="6E":35,1:"")  Q:SRI=""
 ...
 F SRK="1D","4D","3D","5D","2E","6F" S SRKO=$S(SRK="4D":30,SRK="3D":31,SRK="5D":32,SRK="2E":29,SRK="6F":21,SRK="1D":36,1:"") I $P(SRAO(SRK),"^")'="" D
...
DISP W:$E(IOST)'="C" ! W !,?21,"PERIOPERATIVE OCCURRENCE INFORMATION",!!,"WOUND OCCURRENCES:",?33,$P(SRAO(1),"^"),?41,"CNS OCCURRENCES:",?74,$P(SRAO(4),"^")
 ...
 W !,"Pneumonia:",?30,$P(SRAO("2A"),"^"),?41,"Bleeding/Transfusions:",?71,$P(SRAO("6A"),"^")
 W !,"Unplanned Intubation:",?30,$P(SRAO("2B"),"^"),?41,"Graft/Prosthesis/Flap Failure:",?71,$P(SRAO("6B"),"^")
 W !,"Pulmonary Embolism:",?30,$P(SRAO("2C"),"^"),?41,"DVT/Thrombophlebitis:",?71,$P(SRAO("6C"),"^")
 W !,"On Ventilator > 48 Hours:",?30,$P(SRAO("2D"),"^"),?41,"Systemic Sepsis: " D
 .I $P(SRAO("6D"),"^")="   NO" W ?71,$P(SRAO("6D"),"^") Q
 .W $J($P(SRAO("6D"),"^"),21)
 W !,$P(SRAO("2E"),"^"),?41,"Organ/Space SSI:",?71,$P(SRAO("6E"),"^")
 W !,?41,$P(SRAO("6F"),"^")
