FBAA79 ;AISC/GRR-PRINT FORM 7079 REQUEST FOR OUTPATIENT MEDICAL SERVICES ;09/28/00
 ;;3.5;FEE BASIS;**12,23**;JAN 30, 1995
...
GOT Q:'$D(^DPT(DFN,0))
 ...
 S SEX=$P(Y(0),U,2)
 S SSN=$TR($$SSN^FBAAUTL(DFN),"-",""),YOB=$S($P(Y(0),U,3)]"":$E($P(Y(0),U,3),1,3)+1700,1:""),POS=$S($D(^DPT(DFN,.32)):$P(^(.32),"^",3),1:""),POS=$S(POS]"":$P(^DIC(21,POS,0),"^",3),1:"")
 F I=1:1:7 S FBI(I)=""
