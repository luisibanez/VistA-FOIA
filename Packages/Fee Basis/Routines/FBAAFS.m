FBAAFS ;WCIOFO/dmk,SAB-OUTPATIENT FEE SCHEDULE ;8/26/1999
 ;;3.5;FEE BASIS;**4,53,71,92**;JAN 30, 1995
 ;
...
FAC(POS) ; call to determine if the place of service is a facility
 ...
 S NFCODE="^01^03^04^11^12^13^14^15^20^25^32^33^49^50^54^55^57^60^62^65^71^72^81^99^"
