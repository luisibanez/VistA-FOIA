XINDX11 ;ISC/GRK - Create phantom routines for functions, options, etc. ;07/08/98  15:06 [ 04/02/2003   8:47 AM ]
 ;;7.3;TOOLKIT;**1001**;APR 1, 2003
 ;;7.3;TOOLKIT;**20,27**;Apr 25, 1995
 ;THIS ROUTINE CONTAINS AN IHS MODIFICATION BY IHS/ASDST/GTH 01/22/01
 W !,"The option and function files are being processed.",!
 I INP(10)=9.4 G PKG
 N KRN,TYPE ;Build file
 ;----- BEGIN IHS MODIFICATION
 ;THE LINE BELOW IS COMMENTED OUT AND REPLACED BY A NEW LINE TO CHECK
 ;FOR EXISTENCE OF AN ^XPD(9.6... NODE
 ;ORIGINAL MODIFICATION BY IHS/ASDST/GTH 01/22/01
 ;S INDFN="^DD(""FUNC"",",INDRN="|func",INDD="Function",INDSB="FUNC",INDXN="Build file" D HDR
 I $D(^XPD(9.6,INDDA,"KRN",.5,"NM")) S INDFN="^DD(""FUNC"",",INDRN="|func",INDD="Function",INDSB="FUNC",INDXN="Build file" D HDR
 ...
 I $D(^XPD(9.6,INDDA,"KRN",19,"NM")) S INDFN="^DIC(19,",INDRN="|opt",INDD="Option",INDSB="OPT",INDXN="Build file" D HDR
 ;----- END IHS MODIFICATION
