GMRAPES0 ;HIRMFO/RM-SELECT PATIENT ALLERGY TO EDIT ;05-May-2011 10:50;DU
 ;;4.0;Adverse Reaction Tracking;**13,17,19,21,23,20,1002**;Mar 29, 1996;Build 32
...
SENDREQ(USER,PAT,TEXT,GMRAET) ;Send email to GMRA REQUEST NEW REACTANT indicating user's request for a new allergy
 ...
 S GMRATXT(CNT)="by "_GMRAUI(200,GMRAUS,.01,"E")
 ;_" for patient "_GMRAPI(2,GMRAPS,.01,"E")_" ("_$E(GMRAPI(2,GMRAPS,.09,"I"),6,9)_")",CNT=CNT+1
