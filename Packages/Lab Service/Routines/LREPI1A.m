LREPI1A ;DALLAS/SED - EMERGING PATHOGENS HL7 BUILDER ; 5/1/98
...
CY ;BUILD HL7 MSG FOR CY SUBSCRIPT
 ...
 .S ^TMP("HL7",$J,CNT)="OBR"_HLFS_LRDATA,CNT=CNT+1,SEQ=SEQ+1
 ...
 ..S ^TMP("HL7",$J,CNT)=LRDATA,DGCNT=DGCNT+1,CNT=CNT+1
 K LRDATA,DGCNT
 ...
 ...S ^TMP("HL7",$J,CNT)="OBX"_HLFS_LRDATA,CNT=CNT+1,SEQX=SEQX+1
 Q
