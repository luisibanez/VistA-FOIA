LRCAPPH ;DALOI/FHS - PROCESS PHLEBOTOMY WORKLOAD DATA ; 5/1/99
 ;;5.2;LAB SERVICE;**1,19,127,136,138,158,153,263,264**;Sep 27, 1994
...
PHLE I $G(LRCC),LRCEX'=$G(LRCEXV) D
 ...
 . D
 . . S LRTST=0 F  S LRTST=$O(^LRO(69,LRCDT,1,LRSN,2,LRTST)) Q:LRTST<1  Q:'$P(^(LRTST,0),U,11)
 . . Q:'LRTST  S LREN5=^LRO(69,LRCDT,1,LRSN,2,LRTST,0)
