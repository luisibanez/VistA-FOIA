LROE ;DALOI/CJS/FHS-LAB ORDER ENTRY AND ACCESSION ;JUL 06, 2010 3:14 PM
 ;;5.2;LAB SERVICE;**100,121,201,221,263,286,1027**;NOV 01, 1997
 K LRORIFN,LRNATURE,LREND,LRORDRR
 S LRLWC="WC"
 D:$G(SNAPSHOT) ENTRYAUD^BLRUTIL("^LROE 0.0")
 S:$G(BLROPT)=""!($G(BLROPT(0))'=$P(XQY0,U)) BLROPT="ACCWARD",BLROPT(0)=$P(XQY0,U)  ;IHS/OIRM TUC/AAB 2/1/97
 D ^LRPARAM
 D:$G(SNAPSHOT) ENTRYAUD^BLRUTIL("^LROE 5.0")
 I $G(LREND) S LREND=0 Q
 D:$G(SNAPSHOT) ENTRYAUD^BLRUTIL("^LROE 0.9")
L5 ;
NEXT ;from LROE1
 K DIR
