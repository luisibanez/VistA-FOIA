LRDRAW ;DALOI/CJS/RLM-WARD COLLECTION SUMMARY ;8/11/97 [ 04/14/2003  7:51 AM ]
...
END ;K DIC,%ZIS,LRODT,LRLLOC,LRPGM,LRIO,LRTIME,LRDC,LRDFN,LRDPF,LRIOZERO,LRLWC,LRSN,PNM,SSN,Z
 ...
 K DIC,%ZIS,LRODT,LRLLOC,LRPGM,LRIO,LRTIME,LRDC,LRDFN,LRDPF,LRIOZERO,LRLWC,LRSN,PNM,SSN,HRCN,Z  ;IHS/ANMC/CLS 11/1/95
...
GO ;S:$D(ZTQUEUED) ZTREQ="@" U IO S LRDC=0 W @IOF,!,"List of Patients with Lab Orders",?40,"Order Date: "_$$FMTE^XLFDT(LRODT,""),!
 ...
 ;----- BEGIN IHS MODIFFICATIONS LR*5.2*1018
...
PRNT S LRDFN=+^LRO(69,LRODT,1,LRSN,0),LRLWC=$P(^(0),U,4),LRDC=1
 ...
 W !!,PNM,?30,HRCN,?50,"ORDER NUMBER: ",$S($D(^LRO(69,LRODT,1,LRSN,.1)):+^(.1),1:"?"),!,"LOCATION: ",LRLLOC,?50,$S(LRLWC="SP":"SEND PATIENT",LRLWC="WC":"WARD/CLINIC COLLECT",LRLWC="LC":"LAB COLLECT",1:"")  ;IHS/OIRM TUC/AAB 11/6/97
 ;----- END IHS MODIFICATIONS
