LROW2 ; IHS/DIR/AAB - TEST & SAMPLE VERIFICATION 8/11/97 ; [ 11/19/2002  8:37 AM ]
 ;;5.2T9;LR;**1003,1011,1015,1018**;Nov 17, 2004
...
NEXT L +^LRO(69,LRYR,2) S LRORD=1+^LRO(69,LRYR,2) F  Q:'$D(^LRO(69,"C",LRORD))  S LRORD=LRORD+1
 ...
 I '$G(BLRGUI),'$D(ZTQUEUED) W !,"LAB Order number: ",LRORD
 S:$D(ZTQUEUED) ZTREQ="@"
 Q
CHECK ;from LROE1
...
OR ;OE/RR 2.5
 ...
 ;S ORIFN=LRORIFN,ORETURN("ORPK")=LRODT_"^"_LRSN_"^"_LRTN D RETURN^BLRORX:ORIFN  ;IHS/DIR TUC/AAB 06/15/98
 ;S ORIFN=LRORIFN,ORETURN("ORPK")=LRODT_"^"_LRSN_"^"_LRTN ;D RETURN^BLRORX:ORIFN  ;IHS/ITSC/TPF 07/30/01 TOOK OUT DUMMY CALL TO BLRORX
