LREPIRM ;DALLAS/SED - EMERGING PATHOGENS SEARCH ; 7/16/96
...
AUTO ; CHECKS TO SEE IF IT IS TIME TO RUN A SEARCH
 ...
 ..K LREPI
 ..S D0=0 F  S D0=$O(^TMP($J,"CYC",LRCYC,LRRPS,D0)) Q:+D0'>0  D
 ...S LRRPE=$P(^TMP($J,"CYC",LRCYC,LRRPS,D0),U,1),LREPI(D0)=""
 ..S LRRTYPE=0
 ..D TASK
 G EXIT
