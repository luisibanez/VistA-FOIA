DGRPXI ; GENERATED FROM 'DGRP ENTER/EDIT ANNUAL INCOME' INPUT TEMPLATE(#475), FILE 408.21;12/10/01
 D DE G BEGIN
...
BEGIN S DNM="DGRPXI",DQ=1
 ...
 M DIEZAR=^DIE(475,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=475,U="^"
