DGENPTA1 ;ALB/CJM - Patient API - File Data; 12/6/00 5:01pm ; 12/6/00 5:34pm
 ;;5.3;Registration;**121,147,314,677**;Aug 13,1993
 ;
LOCK(DFN) ;
...
FIELD(SUB) ;
 ...
 ;
 Q $S(SUB="DEATH":.351,SUB="PATYPE":391,SUB="VETERAN":1901,SUB="NAME":.01,SUB="DOB":.03,SUB="SEX":.02,SUB="SSN":.09,SUB="PREFAC":27.02,SUB="INELDATE":.152,SUB="INELREA":.307,SUB="INELDEC":.1656,SUB="PID":.363,SUB="EMGRES":.181,1:"")
