...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=2,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 ...
 I $D(^(.321)) S %Z=^(.321) S %=$P(%Z,U,1) S:%]"" DE(12)=% S %=$P(%Z,U,2) S:%]"" DE(13)=%
...
R5 D DE
 ...
 ;
6 S DW="0;2",DV="RSa",DU="",DLB="SEX",DIFLD=.02
 S DE(DW)="C6^DGPTX11"
...
C6F1 Q
X6 Q
7 D:$D(DG)>9 F^DIE17,DE S DQ=7,DW="0;3",DV="RDXOa",DU="",DLB="DATE OF BIRTH",DIFLD=.03
...
C7F1 N X,X1,X2 S DIXR=178 D C7X1(U) K X2 M X2=X D C7X1("O") K X1 M X1=X
 D
...
X12 S DFN=DA D SV^DGLOCK
 Q
 ;
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,DW=".321;2",DV="RSX",DU="",DLB="AGENT ORANGE EXPOS. INDICATED?",DIFLD=.32102
 S DE(DW)="C13^DGPTX11"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
