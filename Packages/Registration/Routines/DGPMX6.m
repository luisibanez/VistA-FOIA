DGPMX6 ; GENERATED FROM 'DGPM SPECIALTY TRANSFER' INPUT TEMPLATE(#451), FILE 405;09/14/99
 D DE G BEGIN
...
X12 S ^DISV(DUZ,"DGPM6")=$S($D(^DISV(DUZ,"^DG(405.1,")):^("^DG(405.1,"),1:"")
 Q
13 S DQ=14 ;@30
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="0;9",DV="R*P45.7'",DU="",DLB="FACILITY TREATING SPECIALTY",DIFLD=.09
 S DE(DW)="C14^DGPMX6"
 S DU="DIC(45.7,"
 G RE
