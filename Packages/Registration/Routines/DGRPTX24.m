...
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,D=0 K DE(1) ;361
 S DIFLD=361,DGO="^DGRPTX25",DC="3^2.0361IP^E^",DV="2.0361M*P8'X",DW="0;1",DOW="ELIGIBILITY",DLB="Select "_DOW S:D DC=DC_D
 S DU="DIC(8,"
...
R3 D DE
 ...
 ;
4 S DW=".32;3",DV="*P21'Xa",DU="",DLB="PERIOD OF SERVICE",DIFLD=.323
 S DE(DW)="C4^DGRPTX24"
 S DU="DIC(21,"
 G RE
