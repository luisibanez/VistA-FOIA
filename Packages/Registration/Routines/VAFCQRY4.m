VAFCQRY4	;BIR/CMC-CONT TO BLD PID 2.4 SEGMENT ;1/23/06
	;;5.3;Registration;**707**;Aug 13, 1993;Build 3
	;
CONT(DFN,APID,PID,HL,HLES,SARY,SEQ,ERROR,REP,COMP)	; continue to bld pid segment
	...
	.I VADM(12)>0 D
	..S RACE="",IEN=0
	..D SEQ10^VAFHLPI1("T",HL("Q"))
	..F  S IEN=$O(VAFY(10,IEN)) Q:IEN=""  D
	...I IEN>1 S RACE=RACE_REP
	...S RACE=RACE_VAFY(10,IEN,1)_COMP_VAFY(10,IEN,2)_COMP_VAFY(10,IEN,3)_COMP_$P(VAFY(10,IEN,1),"-",1,2)_COMP_COMP_"L"
	...
	.I $G(VADM(11))'=0 D
	..D SEQ22^VAFHLPI1("T",HL("Q"))
	..S APID(23)=VAFY(22,1,1)_COMP_VAFY(22,1,2)_COMP_VAFY(22,1,3)_COMP_$P(VAFY(22,1,1),"-",1,2)_COMP_COMP_"L"
