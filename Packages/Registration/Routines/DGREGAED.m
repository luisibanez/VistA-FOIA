...
DISPUS(DGCMP,DGM,FLG) ;tag to display US data
 ...
 . I $G(DUZ("AG"))="E" W !,?6," Alt Phone: ",?16,$P($G(DGCMP(DGM,.134)),U)
...
INPT1(DFN,FORGN,PSTR) ; first address input prompts
 ...
 ;Begin WorldVistA Change ;DG*5.3*634 (add .134 to strings)
 S PSTR=".111,.112,.113,.114,.115,.117,.1112,.1171,.1172,.1173,.131,.132,.134,.121"
 S FSTR=".111,.112,.113,.1112,.131,.132,.134,.121"
 I FORGN S FSTR=".111,.112,.113,.114,.1171,.1172,.131,.132,.134,.121"
 ;End WorldVistA Change
 Q FSTR
