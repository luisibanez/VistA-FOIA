ORQRY01 ;SLC/JDL - Order query utility ;3/15/05  08:37
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**153,174,215**;Dec 17, 1997
 ;
...
SDA(ERR,ERRMSG) ; common call to scheduling to return new variables for errors - out of scope
 D SDA^VADPT
 S ERR=VAERR
 I ERR=1 S ERRMSG="^Error encountered" Q
 I ERR=2 S ERRMSG="^Database is unavailable" Q
 S ERRMSG=""
 Q
 ;
