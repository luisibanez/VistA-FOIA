OCXOZ02 ;SLC/RJS,CLA - Order Check Scan ;OCT 20,2005 at 22:40
...
CHK1 ; Look through the current environment for valid Event/Elements for this patient.
 ...
 I $L(OCXDF(37)) S OCXDF(146)=$P($$PATLOC(OCXDF(37)),"^",1) I $L(OCXDF(146)) D CHK443^OCXOZ0E
 I $L(OCXDF(12)),$L(OCXDF(152)),$L(OCXDF(113)) D CHK470^OCXOZ0F
 Q
 ;
