ORWDX1 ; SLC/KCM/REV - Utilities for Order Dialogs ;10/14/05
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**85,187,195,215**;Dec 17, 1997
 ;
...
DLGDEF(LST,DLG) ; Format mapping for a dlg
 ...
 Q
 ;
CHANGE(ORLST,ORCLST,DFN) ;
 N CATCH,CNT,INP,INPDIEN,IVM,IVMDIEN,ORIEN,ORLOC,OR3,ORDG
 N CIEN,DIAL,TDIAL,TDIEN,UDIEN,QORDDG
 ...
 S TDIAL=$O(^ORD(101.41,"B","OR GXTEXT WORD PROCESSING ORDE","")) Q:TDIAL'>0
 ...
 .I ORDG'=INPDIEN,ORDG'=IVMDIEN,ORDG'=UDIEN,ORDG'=TIEN,ORDG'=CIEN Q
 .S ORLOC=$P($G(ORCLST(CNT)),U,2)
 .S OR3=$G(^OR(100,ORIEN,3))
 .S DIAL=$P(OR3,U,4)
 .
 .;
 .I $P($G(^OR(100,ORIEN,0)),U,10)=(ORLOC_";SC(") D  Q
 ..;Remove treating spec. if IMO order 26.42
 ..I $P($G(^OR(100,ORIEN,0)),U,11)=CIEN S $P(^OR(100,ORIEN,0),U,13)=""
 .;
 .;CHANGE PATIENT LOCATION AND PATIENT STATUS.
 .S $P(^OR(100,ORIEN,0),U,10)=ORLOC_";SC("
 .S $P(^OR(100,ORIEN,0),U,12)="I"
 .;
 ...
 .I CATCH=$P($G(^OR(100,ORIEN,0)),U,11) D
 ...
 .I (DIAL=(IVM_";ORD(101.41,"))!(DIAL=(INP_";ORD(101.41,")) D
