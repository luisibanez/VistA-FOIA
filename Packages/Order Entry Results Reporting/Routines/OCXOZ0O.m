OCXOZ0O	;SLC/RJS,CLA - Order Check Scan ;AUG 11,2009 at 08:45
...
R24R1A	; Verify all Event/Elements of  Rule #24 'ORDERER FLAGGED RESULTS AVAILABLE'  Relation #1 'ORDER FLAGGED FOR RESULTS AND (LAB RESULT OR IMAGI...'
	;  Called from EL5+5^OCXOZ0H, and EL49+5^OCXOZ0H, and EL55+5^OCXOZ0H, and EL101+5^OCXOZ0H.
	;
	Q:$G(OCXOERR)
	;
	;      Local Extrinsic Functions
