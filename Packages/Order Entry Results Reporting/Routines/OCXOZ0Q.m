OCXOZ0Q	;SLC/RJS,CLA - Order Check Scan ;AUG 11,2009 at 08:45
...
R35R1A	; Verify all Event/Elements of  Rule #35 'LAB ORDER CANCELLED'  Relation #1 '(CANCEL OR REQCANCEL) AND CANCELED BY NON-ORIG ORD...'
	;  Called from EL100+8^OCXOZ0G, and EL20+5^OCXOZ0H, and EL40+5^OCXOZ0H.
	;
	Q:$G(OCXOERR)
	;
