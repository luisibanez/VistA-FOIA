ORCACT01	;SLC/MKB-Validate order actions cont ;1:39 PM  3 Apr 2010
	;;3.0;ORDER ENTRY/RESULTS REPORTING;**94,116,134,141,163,187,190,213,243,NO HOME**;Dec 17, 1997;Build 13;WorldVistA 30-June-08
	;
...
ES1	I PKG="PS" D  ;authorized to write meds?
	...
	. ;Begin WorldVistA change ;NO HOME
	. ;I (DEAFLG>0||$$ISCLOZ^ORALWORD(OI)),'$L($$DEA^XUSER()) S ERROR="You must have a valid DEA# or VA# to sign this order!" Q
	. I $S(DEAFLG>0:1,$$ISCLOZ^ORALWORD(OI):1,1:0),'$L($$DEA^XUSER()) S ERROR="You must have a valid DEA# or VA# to sign this order!" Q
