ORWDXM1 ; SLC/KCM - Order Dialogs, Menus;2/19/03 ;11/15/2005
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,131,132,141,178,185,187,215**;Dec 17, 1997
BLDQRSP(LST,ORIT,FLDS,ISIMO) ; Build responses for an order
 ...
 D SETUPS^ORWDXM4 ; moved to save space
 Q:+LST(0)=8
