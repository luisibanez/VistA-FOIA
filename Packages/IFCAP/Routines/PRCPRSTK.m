PRCPRSTK ;WISC/RFJ-where is an item stocked                         ;07 Sep 91
...
DQ ;queue comes here
 ...
 .   S TYPE=$S(TYPE="W":"WAREHOUSE",TYPE="P":"PRIMARY",TYPE="S":"SECONDARY",1:" "),^TMP($J,"PRCPRSTK",TYPE,I)=+$P(%,"^",7)_"^"_$J($$UNITVAL^PRCPUX1($P(%,"^",14),$P(%,"^",5)," per "),12)
 ...
 .   W !,TYPE,?12,I,?49,$J($P(DATA,"^"),11),?65,$P(DATA,"^",2)
...
H S %=DATE_"  PAGE "_PAGE,PAGE=PAGE+1 I PAGE'=2!(SCREEN) W @IOF
 ...
 W !?4,"NSN: ",NSN,?30,$E(DESC,1,30),?62,"[#",ITEMDA,"]",!,"TYPE",?12,"SITE-DISTRIBUTION POINT",?49,"QTY ON-HAND",?66,"UNIT per ISSUE"
 S %="",$P(%,"-",81)="" W !,% Q
