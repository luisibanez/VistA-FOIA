PRCPRAIP ;WISC/RFJ-abbreviated item report (primary, second)        ;09 Jun 93
...
DQ ;  queue starts here
 ...
 .   .   I $Y>(IOSL-6) D:SCREEN P^PRCPUREP Q:$D(PRCPFLAG)  D H
 .   .   S ITEMDATA=$G(^PRCP(445,PRCP("I"),1,ITEMDA,0))
 .   .   W !,$E(X,1,23),?24,ITEMDA,?31,$TR($$NSN^PRCPUX1(ITEMDA),"-"),?46,$J(+$P(ITEMDATA,"^",7),8),$J($$UNIT^PRCPUX1(PRCP("I"),ITEMDA,"/"),10),$J($$STORAGE^PRCPESTO(PRCP("I"),ITEMDA),16)
...
H S %=NOW_"  PAGE "_PAGE,PAGE=PAGE+1 I PAGE'=2!(SCREEN) W @IOF
 ...
 S %="",$P(%,"-",81)=""
 W !,"DESCRIPTION",?24,"MI",?31,"NSN",?41,$J("QTY OH",13),$J("UNIT/IS",10),$J("MAIN STORAGE",16),!?5,"ADD STORAGE",?26,"ADD STORAGE",?46,"ADD STORAGE",?66,"ADD STORAGE",!,%
 Q
