PRCPAGRO ;WISC/RFJ,DXH - autogenerate print suggested distribution order ;10.4.99
...
ORDER ;  print order to create
 ...
 N %,%H,%I,D,DESCNSN,GNM,ITEMDA,NOW,ORDER,PAGE,SCREEN,TOTCOST,VDA,VNM,X,Y
...
H S %=NOW_"  PAGE "_PAGE,PAGE=PAGE+1 I PAGE'=2!(SCREEN) W @IOF
 W $C(13),"AUTO-GEN: SUGGESTED ORDERS FOR ",$E(PRCP("IN"),1,20),?(82-$L(%)),%
