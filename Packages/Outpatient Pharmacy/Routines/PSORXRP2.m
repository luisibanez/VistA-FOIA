PSORXRP2	;BIR/SAB-main menu entry reprint of a Rx label ;7:37 AM  31 Dec 2008
	;;7.0;OUTPATIENT PHARMACY;**11,27,120,138,135,156,185,280,208**;DEC 1997;Build 54;WorldVistA 30-Jan-08
	;
...
LRP	N PSODISP
	...
	D ^DIC K DIC ;vfah
	S PSOZAF=+Y ;vfah
	I $P(^PSRX(RX,"OR1"),"^",5)=$G(PSOZAF) W $C(7),!,"Cannot Reprint Labels for Autofinished Rxs" D ULR,KILL Q  ;vfah
	;WVEHR ;end p208
