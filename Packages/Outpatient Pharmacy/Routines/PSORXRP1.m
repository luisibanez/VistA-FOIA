PSORXRP1	;BIR/SAB-rx speed reprint listman ; 12/10/06 9:50pm
	;;7.0;OUTPATIENT PHARMACY;**11,27,120,156,148,208**;DEC 1997;Build 54
...
RX	;process reprint request
	...
	D ^DIC K DIC ;vfah
	S PSOZAF=+Y ;vfah
	I $P($G(^PSRX($P(PSOLST(ORN),"^",2),"OR1")),"^",5)=$G(PSOZAF) W $C(7),!!,"Rx "_$$GET1^DIQ(52,$P(PSOLST(ORN),"^",2),.01)_" is an Autofinish,Rx and labels can not be reprinted." K PSOZAF D PAUSE^VALM1 Q  ;vfah
	;
