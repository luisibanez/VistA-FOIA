PSORXPA1	;BIR/SAB - listman partial prescriptions ;2:10 PM  28 May 2009
	;;7.0;OUTPATIENT PHARMACY;**11,27,56,77,130,152,181,174,287**;DEC 1997;Build 54;WorldVistA 30-Jan-08
	;
	...
	D ^DIC K DIC ;vfah
	S PSOZAF=+Y  ;vfah Quits if AUTOFINISH,RX not a user
	I $P($G(^PSRX(RXN,"OR1")),"^",5)=$G(PSOZAF) S VALMBCK="",VALMSG="Partial option is not available for Autofinshed Rxs" K PSOZAF Q  ;vfah
	; End WV EHR change
