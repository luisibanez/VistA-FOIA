PSODISPS	;BIR/SAB-CONTINUATION OF RELEASE FUNCTION ;3/2/93
	;;7.0;OUTPATIENT PHARMACY;**15,13,9,27,67,71,156,118,148,247,200,208**;DEC 1997;Build 54
...
QTY	; Refill Release
	...
	I $G(PSOAFYN)'="Y" W:'$G(IFN) !?7,"No "_$S($G(XTYPE):"Refill(s)",1:"Partial(s)")_" to be Released" ;vfah - VOE
