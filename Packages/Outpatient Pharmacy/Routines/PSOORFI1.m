PSOORFI1	;BIR/SAB - finish OP orders from OE/RR continued ;10:45 AM  3 Aug 2009
	;;7.0;OUTPATIENT PHARMACY;**7,15,23,27,32,44,51,46,71,90,108,131,152,186,210,222,258,260,225,208**;DEC 1997;Build 54;WorldVistA 30-June-08
	;
...
DSPL	K ^TMP("PSOPO",$J),CLOZPAT,PSOPRC,PSODSPL
	...
	I '$P(OR0,"^",9)&($G(PSOAFYN)="Y") D DISPD^PSOAFIN G DSPL ;vfah 060924
...
POST	;post patient selection
	;Begin WorldVistA change; PSO*7*208; 08/02/2009
	I $G(PSOAFYN)'="Y" D POST^PSOORFI2 Q
	I $G(PSOAFYN)="Y" Q  ;vfah
	;End WorldVistA change
