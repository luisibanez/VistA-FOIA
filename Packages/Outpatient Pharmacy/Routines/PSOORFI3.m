PSOORFI3	;BIR/RTR-finish CPRS orders by Clinic ;11:55 AM  3 Jan 2010
	;;7.0;OUTPATIENT PHARMACY;**15,27,32,46,84,99,130,117,139,172,225,300,208**;DEC 1997;Build 54;WorldVistA 30-June-08
	;
...
L1	;Lock single order
	...
	K PSOMSG D PSOL^PSSLOCK(+ORD_"S") I '$G(PSOMSG),'$D(ZTSK) W !!,$S($P($G(PSOMSG),"^",2)'="":$P($G(PSOMSG),"^",2),1:"This Order is being edited by another person."),! K DIR S DIR(0)="E",DIR("A")="Press Return to Continue" D ^DIR K DIR
