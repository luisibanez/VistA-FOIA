PSORXRPT	;BIR/SAB-reprint of a prescription label ;7:48 AM  31 Dec 2008
	;;7.0;OUTPATIENT PHARMACY;**3,21,27,34,120,138,156,148,280,208**;DEC 1997;Build 54;WorldVistA 30-Jan-08
	;
...
BCK	I $G(PSOBEDT) W $C(7),$C(7) S VALMSG="Invalid Action at this time !",VALMBCK="" Q
	...
	D ^DIC K DIC ;vfah
	S PSOZAF=+Y ;vfah
	I $P($G(^PSRX(RX,"OR1")),"^",5)=$G(PSOZAF) S VALMBCK="",VALMSG="This reprint option is not available for Autofinshed Rxs",QFLG=1 K PSOZAF D ULR,KILL Q  ;vfah
	;WVEHR ;end p208
	;
