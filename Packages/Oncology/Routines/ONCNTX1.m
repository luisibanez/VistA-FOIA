ONCNTX1 ;Hines OIFO/RTK;NO TREATMENT STUFFING; 02/5/98
 ;;2.11;ONCOLOGY;**15,16,19,22,25,26,27,32,36,37,38,39,41,42,45**;Mar 07, 1995
 ;
...
CHEMATF ;CHEMOTHERAPY @FAC (165.5,53.3)
 ...
 I $D(NTX) D
 .N DR,DP,DL
 .S DIE="^ONCO(165.5,",DR=53.3 D ^DIE
...
HTATF ;HORMONE THERAPY @FAC (165.5,54.3)
 ...
 I $D(NTX) D
 .N DR,DP,DL
 .S DIE="^ONCO(165.5,",DR=54.3 D ^DIE
...
IMMATF ;IMMUNOTHERAPY @FAC (165.5,55.3)
 ...
 I $D(NTX) D
 .N DR,DP,DL
 .S DIE="^ONCO(165.5,",DR=55.3 D ^DIE
...
HOR ;HORMONE THERAPY (165.5,54.2)
 I $D(NTX) D
 .N DR,DP,DL
 .S DIE="^ONCO(165.5,",DR=54.2 D ^DIE
...
IMM ;IMMUNOTHERAPY (165.5,55.2)
 I $D(NTX) D
 .N DR,DP,DL
 .S DIE="^ONCO(165.5,",DR=55.2 D ^DIE
...
RFNRHLP ;REASON FOR NO RADIATION (165.5,75) help
 W !,"   Record the reason that no regional radiation"
