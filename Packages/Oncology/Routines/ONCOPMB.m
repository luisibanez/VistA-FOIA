ONCOPMB ;Himes OIFO/GWB - CONTINUATION OF ONCOPMA ;12/14/99
 ;;2.11;ONCOLOGY;**11,23,25,44**;Mar 07, 1995
...
5 ;[MA Print QA/Multiple Abstracts - 5 Abstracts by DATE DX]
 ...
 ;
TK5 S XDT=ONCOD(1)-1
 F  S XDT=$O(^ONCO(165.5,"ADX",XDT)) Q:XDT=""  Q:XDT>ONCOD(2)  D  G:'Y EX
 .S IEN=0 F  S IEN=$O(^ONCO(165.5,"ADX",XDT,IEN)) Q:IEN=""  I $$DIV^ONCFUNC(IEN)=DUZ(2),$P($G(^ONCO(165.5,IEN,7)),U,2)=3 D  I ONCIOST?1"C".E W ! K DIR S DIR(0)="E",DIR("A")="Enter RETURN to go to next abstract or '^' to exit" D ^DIR Q:'Y
 ..S (NUMBER,ONCODA)=IEN
 ..S IOP=ONCOION
 ..D @PRINT
 G EX
