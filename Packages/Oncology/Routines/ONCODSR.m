ONCODSR ;Hines OIFO/RTK,GWB - SURGERY OF PRIMARY SITE; 12/22/00
 ;;2.11;ONCOLOGY;**1,5,6,7,11,13,15,16,18,27,36,37,42**;Mar 07, 1995
 ;
SS ;SITE SPECIFIC SURGERY
...
DFSPIT ;DATE FIRST SURGICAL PROCEDURE (165.5,170) Input Transform
 ;Must be <= MOST DEFINITIVE SURG DATE      (165.5,50)
 ;Must be <= MOST DEFINITIVE SURG @FAC DATE (165.5,50.3)
 ;Must be <= SCOPE OF LN SURGERY DATE       (165.5,138.2)
 ;Must be <= SCOPE OF LN SURGERY @FAC DATE  (165.5,138.3)
 ;Must be <= SURG PROC/OTHER SITE DATE      (165.5,139.2)
 ;Must be <= SURG PROC/OTHER SITE @FAC DATE (165.5,139.3)
 D ZS9S Q:'$D(X)  Q:(X="0000000")!(X=9999999)
...
DBTE ;DATE BRACHYTHERAPY ENDED INPUT TRANSFORM (NOT FUTURE, DBS<=DBE)
 ...
 Q
 ;
ZS9S ;00/00/0000 and 99/99/9999 INPUT TRANSFORM
 S ZS9S=1
