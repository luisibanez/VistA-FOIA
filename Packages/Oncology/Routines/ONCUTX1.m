ONCUTX1 ;Hines OIFO/RTK; UNKNOWN TREATMENT STUFFING; 08/11/98
 ;;2.11;ONCOLOGY;**19,22,27,29,33,36,37,38,39,41,42,44**;Mar 07, 1995
 ;
...
IMMATF ;IMMUNOTHERAPY @FAC (165.5,55.3)
 I $G(X)'=8 S $P(^ONCO(165.5,DA,3.1),U,18)=99
