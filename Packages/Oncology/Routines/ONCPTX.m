ONCPTX ;Hines OIFO/GWB - FIRST COURSE OF TREATMENT ;9/24/97
 ;;2.11;ONCOLOGY;**13,15,17,19,27,32,34,36,37,39,41,42,45**;Mar 07, 1995
 ;
NCDS D FST^ONCOAIP
...
FORDS ;SURGICAL PROCEDURES (FORDS)
 ...
 .S $P(^ONCO(165.5,D0,3.1),U,29)=$S(DATEDX>2971231:1,1:"00")
 N DI,DIC,DR,DA,DIQ K ONC
 S DIC="^ONCO(165.5,"
 S DR="50;58.6;50.3;58.7;59;138:138.5;139:139.5;435;14;58;23;74;58.2;50.2;140;140.1;170"
 S DA=D0,DIQ="ONC(" D EN^DIQ1
 F I=58.6,58.7,59,138,138.1,138.4,138.5,139,139.1,139.4,139.5,435,14,58,23,74,58.2,50.2,140,140.1 S X=ONC(165.5,D0,I) D UCASE S ONC(165.5,D0,I)=X
 D FST^ONCOAIP
...
ST D FST^ONCOAIP
 ...
 W !," Chemotherapy..................: ",ONC(165.5,DA,53),?44,ONC(165.5,DA,53.2)
 W !," Chemotherapy @fac.............: ",ONC(165.5,DA,53.4),?44,ONC(165.5,DA,53.3)
 W !," Hormone therapy...............: ",ONC(165.5,DA,54),?44,ONC(165.5,DA,54.2)
 W !," Hormone therapy @fac..........: ",ONC(165.5,DA,54.4),?44,ONC(165.5,DA,54.3)
 W !," Immunotherapy.................: ",ONC(165.5,DA,55),?44,ONC(165.5,DA,55.2)
 W !," Immunotherapy @fac............: ",ONC(165.5,DA,55.4),?44,ONC(165.5,DA,55.3)
 W !," Hema Trans/Endocrine Proc.....: ",ONC(165.5,DA,153.1),?44,ONC(165.5,DA,153)
