ONCOFTS ;Hines CIOFO/GWB/RTK - TUMOR STATUS/CANCER STATUS OF PRIMARY ;02/02/00
 ;;2.11;ONCOLOGY;**24,25**;Mar 07, 1995
 ;
...
KTSMONE ;kill a single tumor status sub-record
 ...
 Q
 ;
DX ;DATE OF LAST CONTACT OR DEATH (160.04,.01,0) Input Transform 
 ...
 N ONCOF,XD1
 S ONCOF=0,XD1=0 F  S XD1=$O(^ONCO(165.5,"C",DA(1),XD1)) Q:XD1'>0  I $P(^ONCO(165.5,XD1,0),U,16)'>X S ONCOF=1 Q
