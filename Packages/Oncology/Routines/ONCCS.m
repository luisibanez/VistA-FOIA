ONCCS ;Hines OIFO/GWB - COLLABORATIVE STAGING ;11/20/03
 ;;2.11;ONCOLOGY;**40,43,44**;Mar 07, 1995
 ;
 N DIR,X
 W !
 ...
 ;
 S IEN=D0
 S $P(^ONCO(165.5,IEN,"CS1"),U,1)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,2)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,3)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,4)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,5)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,6)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,7)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,8)=""
 S $P(^ONCO(165.5,IEN,"CS1"),U,9)=""
...
INIT ;Initialize CS fields when HISTOLOGY (ICD-O-3) (165.5,22.3) changes
 ...
 S SITEGP=$P($G(^ONCO(165.5,D0,0)),U,1)
