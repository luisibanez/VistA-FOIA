ONCATF ;Hines OIFO/RTK;TREATMENT @FAC STUFFING; 08/12/98
 ;;2.11;ONCOLOGY;**19,25,27,36,40,42**;Mar 07, 1995
 ;
NCDS ;SURG DX/STAGING PROC @FAC (165.5,58.4) 
 D CHKCOC I (COC'=0)&(COC'=1)&(COC'=4) Q
...
DSPSPSR ;Display SURGERY OF PRIMARY @FAC (R) (165.5,50.2)
 D CHKCOC I (COC=0)!(COC=3)!(COC=6) D  K TXNO,TXUNK,TXNUL S Y="@427" Q
...
DSPSPS ;Display SURGERY OF PRIMARY @FAC (F) (165.5,58.7)
 D CHKCOC I (COC=0)!(COC=3)!(COC=6) D  K TXNO,TXUNK,TXNUL S Y="@43" Q
...
DSPSCPR ;Display SCOPE OF LN SURGERY @FAC (R) (165.5,138.1)
 D CHKCOC I (COC=0)!(COC=3)!(COC=6) D  K TXNO,TXUNK,TXNUL S Y="@139" Q
...
DSPSCP ;Display SCOPE OF LN SURGERY @FAC (F) (165.5,138.5)
 D CHKCOC I (COC=0)!(COC=3)!(COC=6) D  K TXNO,TXUNK,TXNUL S Y="@46" Q
...
DSPSOSR ;Display SURG PPROC/OTHER SITE @FAC (R) (165.5,139.1)
 D CHKCOC I (COC=0)!(COC=3)!(COC=6) D  K TXNO,TXUNK,TXNUL S Y="@428" Q
...
DSPSOSN ;Display SURG PPROC/OTHER SITE @FAC (F) (165.5,139.5)
 D CHKCOC I (COC=0)!(COC=3)!(COC=6) D  K TXNO,TXUNK,TXNUL S Y="@48" Q
