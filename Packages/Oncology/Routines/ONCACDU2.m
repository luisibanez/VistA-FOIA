ONCACDU2 ;Hines OIFO/GWB - UTILITY ROUTINE #1;09/20/2000
 ;;2.11;Oncology;**12,18,20,21,22,24,26,27,29,30,31,32,34,36,37,38,39,41**;Mar 07, 1995
 ;
...
COCO(IEN) ;COC Coding Sys--Original [2150] 1202-1203
 ...
 Q X
 ;
STATE() ;Vendor Name [2170] 1204-1213
 N X,VERSION
 S VERSION=$P($G(^ONCO(160.16,EXTRACT,0))," ",3)
 S X="VA"_VERSION_$E($T(LOGO+3^ONCODIS),62,64)
 Q X
 ;
...
SUB164(IEN,SUBFLD,ENTRY) ;ICDO TOPOGRAPHY (164)
 ...
 .I ($G(FIELD)=58.2)!($G(FIELD)=50.2),$E(TOP1,3,4)=77 S TOP2=67422
