ONCNTX ;Hines OIFO/GWB; No treatment stuffing; 08/27/97
 ;;2.11;ONCOLOGY;**13,15,16,19,22,25,26,27,32,33,34,36,37,38,39,41,42,43,44,45**;Mar 07, 1995
 ;
NTX ;No treatment stuffing
 ...
 I (SITE=35)!(SITE=58)!(SITE=63)!(SITE=65)!($$LYMPHOMA^ONCFUNC(DA)=1) D NODEATF^ONCUTX1
 E  D NODEATF^ONCNTX1
...
NODE ;SCOPE OF LN SURGERY (F) (165.5,138.4)
 ;For unknown primary, leukemia, lymphoma, and brain primaries, code 9
 S SITE=$P(^ONCO(165.5,DA,0),U,1)
 I (SITE=35)!(SITE=58)!(SITE=63)!(SITE=65)!($$LYMPHOMA^ONCFUNC(DA)=1) D  D SCPDT^ONCATF Q
...
RFNR ;REASON FOR NO RADIATION (165.5,75)
 W ! K DIR
 S DIR(0)="SA^0:Radiation administered;1:Not part of 1st course;2:Contraindicated;5:Patient died prior to tx;6:Not administered, no reason;7:Refused by patient;8:Unknown if administered;9:Unknown, death cert/autopsy cases"
