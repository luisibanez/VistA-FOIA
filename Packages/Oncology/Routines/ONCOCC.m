ONCOCC ;HINES OIFO/GWB - CLASS OF CASE 5 OR 8 ;06/03/96
 ;;2.11;ONCOLOGY;**5,13,16,19,20,22,24,26,30,33,36,37,39**;Mar 07, 1995
 ;
 ...
 D SCT Q
 ;
COC5 F P=26,35,36,37 S $P(^ONCO(165.5,D0,3),U,P)=2
 ...
 S $P(^ONCO(165.5,D0,3),U,42)=$S(DTDX>2971231:"00",1:"")
 S $P(^ONCO(165.5,D0,3.1),U,11)=$S(DTDX>2971231:"00",1:"")
 ...
 F PP=1,4,8,11,14,17,23,31 S $P(^ONCO(165.5,DA,3),U,PP)="0000000"
 F PP=2,6,8,13:2:19,21:1:25 S $P(^ONCO(165.5,DA,3.1),U,PP)="0000000"
 Q
 ;
