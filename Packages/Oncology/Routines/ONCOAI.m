ONCOAI ;Hines OIFO/GWB - BEGIN ABSTRACT ENTRY ;7/19/93
 ;;2.11;ONCOLOGY;**6,15,17,18,19,25,26,27,28,29,32,33,34,35,43,45**;Mar 07, 1995
 ;
BEG D EX
 W @IOF,!!!
...
CK ;Check for existing primaries
 ;S ONCOP=""
 ;S ONCOP0=0 F  S ONCOP0=$O(^ONCO(165.5,"C",ONCOD0,ONCOP0)) Q:ONCOP0'>0  I $$DIV^ONCFUNC(ONCOP0)=DUZ(2) S ONCOP=$S($D(^ONCO(165.5,ONCOP0,0)):^(0),1:"") Q
 ;I ONCOP'="" G PRIM2
 ;S ONCOP0=""
 ;
...
SET1 D MS^ONCOCOM,EN^ONCOAIP,FOL
