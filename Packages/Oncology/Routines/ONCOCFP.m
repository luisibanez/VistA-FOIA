ONCOCFP ;Hines OIFO/GWB - PTF CASEFINDING ;8/11/93
 ;;2.11;ONCOLOGY;**22,23,25,26,27,28,29,34,43**;Mar 07, 1995
 ;
 W @IOF
...
ED K DIR
 ...
 W !?3,"V77.1          SCREENING FOR DIABETES MELLITUS"
 W !
...
FD I ((IC9>139.9)&(IC9<210)) S CI=1 Q
 ...
 I (IC9=259.2)!(IC9=273.1)!(IC9=273.2)!(IC9=273.3)!(IC9=273.9)!(IC9=284.9)!(IC9=288.3)!(IC9=289.8)!(IC9="042.2") S CI=1 Q
