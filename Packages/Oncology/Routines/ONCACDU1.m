ONCACDU1 ;Hines OIFO/GWB - NAACCR extract utilities #1;06/23/00
 ;;2.11;Oncology;**12,14,16,20,21,22,24,26,27,28,33,36,37,42,45**;Mar 07, 1995
 ;
...
CC ;Comorbid/Complication 1-10
 ...
 .I ($E(CC(CCSUB),1)="E")!($E(CC(CCSUB),1)="V")!(+CC(CCSUB)>99.9) S CCEXSUB=CCEXSUB+1,CCEX(CCEXSUB)=$P(CC(CCSUB),".",1)_$P(CC(CCSUB),".",2)
 ;
