IVMUM4 ;ALB/SEK - ADD NEW INDIVIDUAL ANNUAL INCOME FILE ENTRIES ; 19 MAY 94
 ;;2.0;INCOME VERIFICATION MATCH;**1,8,17**;21-OCT-94
...
EN1 ; add 1 node for vet & child
 ...
 S DIK="^DGMT(408.21,"
 L +^DGMT(408.21,DGINI) S $P(^DGMT(408.21,DGINI,0),"^",8,17)=IVM0,DA=DGINI S:IVMSPCHV'="S" ^(1)=IVM1 S:IVMSPCHV'="C" ^(2)=IVM2 D IX1^DIK L -^DGMT(408.21,DGINI)
 K DA,DIK
 Q
