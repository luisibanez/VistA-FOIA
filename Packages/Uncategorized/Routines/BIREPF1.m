...
PRINT ;EP
 ...
 N VALM,VALMHDR
 D HDR,START^BIREPF2(BIYEAR,.BICC,.BIHCF,.BICM,.BIBEN,BIFH)
 ;
...
HDR ;EP
 ;---> Header code
 D HEAD^BIREPF2(BIYEAR,.BICC,.BIHCF,.BICM,.BIBEN,BIFH)
 Q
 ;
 ;
 ;----------
INIT ;EP
 ...
 W !!?10,"This may take some time.  Please hold on...",!
 D START^BIREPF2(BIYEAR,.BICC,.BIHCF,.BICM,.BIBEN,BIFH)
...
DEQUEUE ;EP
 ...
 D HDR^BIREPF1,START^BIREPF2(BIYEAR,.BICC,.BIHCF,.BICM,.BIBEN,BIFH)
 ;**********
 ;
