...
PATIENT ;EP
 ...
 .....S ABMVDFN=$P($G(^XTMP("ABM-PVH",$J,"PT LST",ABMSDT,ABMVLOC,ABMITYP,ABMINS,ABMPTL,ABMPTF,ABMVDT)),U)
 .....S ABMPT=$P($G(^XTMP("ABM-PVH",$J,"PT LST",ABMSDT,ABMVLOC,ABMITYP,ABMINS,ABMPTL,ABMPTF,ABMVDT)),U,2)
 .....S ABMTRIEN=$P($G(^XTMP("ABM-PVH",$J,"PT LST",ABMSDT,ABMVLOC,ABMITYP,ABMINS,ABMPTL,ABMPTF,ABMVDT)),U,3)
 ...
 .....I $P($G(^XTMP("ABM-PVH",$J,"PT LST",ABMSDT,ABMVLOC,ABMITYP,ABMINS,ABMPTL,ABMPTF,ABMVDT)),U,4)'="" W ?79,$P(^(ABMVDT),U,4)
