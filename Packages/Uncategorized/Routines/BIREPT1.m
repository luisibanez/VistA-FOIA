...
PRINT ;EP
 ...
 N VALM,VALMHDR
 D START^BIREPT2(BIQDT,BITAR,BIAGRPS,.BICC,.BIHCF,.BICM,.BIBEN,BISITE),HDR
 ;
...
HDR ;EP
 ;---> Header code
 D HEAD^BIREPT2(BIQDT,BITAR,BIAGRPS,.BICC,.BIHCF,.BICM,.BIBEN)
 Q
 ;
 ;
 ;----------
INIT ;EP
 ...
 W !!?10,"This may take some time.  Please hold on...",!
 K ^TMP("BIREPT1",$J),^TMP("BIDUL",$J)
 D START^BIREPT2(BIQDT,BITAR,BIAGRPS,.BICC,.BIHCF,.BICM,.BIBEN,BISITE)
