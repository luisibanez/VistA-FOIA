ACHSRPU ; IHS/ITSC/PMF - PRINT UNIVERSAL 843 FORMS ;JUL 10, 2008
 ;;3.1;CONTRACT HEALTH MGMT SYSTEM;**6,7,11,12,13,14,15,16,18,19**;JUN 11,2001
...
PONUM ; -- Field 1 : DCR #, Document type, PDO number.
 ...
 ;I $G(ACHSDIEN) W ?ACHSTAB+61,$E($P(^ACHSF(DUZ(2),"D",ACHSDIEN,0),U,27),3),ACHSORDN,ACHSSF  ;ACHS*3.1*19
