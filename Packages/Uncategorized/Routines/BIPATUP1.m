BIPATUP1 ;IHS/CMI/MWR - UPDATE PATIENT DATA; OCT 15, 2010
 ;;8.4;IMMUNIZATION;**2**;MAY 10,2010
 ;;* MICHAEL REMILLARD, DDS * CIMARRON MEDICAL INFORMATICS, FOR IHS *
 ;;  UPDATE PATIENT DATA, IMM FORECAST IN ^BIPDUE(.
 ;   PATCH 2: Translate forecasted CVX 15 to CVX 141 from now on.  DDUE2+44
 ;   PATCH 2: Include CVX 140 & 141 when checking for Immserve.   DDUE2+84
 ;
 ;----------
