...
ENTRY ;EP
 ...
 ...S:$P(G,U)=1 EXCL=1
 ...;Exclude if refused
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",15,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",16,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",111,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",125,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",126,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",127,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",128,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ...I EXCL'=1 S G=$$REFUSAL^BGPMUUT2(DFN,9999999.14,$O(^AUTTIMM("C",135,0)),BGPBDATE,BGPEDATE)
 ...S:$P(G,U)=1 EXCL=1
 ..D TOTAL(DFN)
