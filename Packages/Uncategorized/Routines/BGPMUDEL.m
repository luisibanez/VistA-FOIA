...
HEADER ;DELIMITED HEADER
 ...
 S Y="*** "_$S($G(BGPMUT)'="H":"Professional (EP)",1:"Hospital")_" Clinical Quality Measures Report ***" D S(Y,1,1)
 S Y="CRS 2011, Version 11.0 Patch 3" D S(Y,1,1)
 ...
 I $G(BGPMUT)'="H" D
 .S Y="Eligible Professional (EP): "_$P(^VA(200,BGPPROV,0),U) D S(Y,1,1)
 I $G(BGPMUT)="H" D
 ...
 I $G(BGPMUT)'="H" D
 .S Y="This report includes the EP "_$S(BGPINDT="C":"core",BGPINDT="A":"alternate",BGPINDT="M":"menu set",1:"selected")_" clinical performance measures for" D S(Y,2,1)
 ...
 .S Y="clinical quality performance measures for Stage 1 Meaningful Use." D S(Y,1,1)
 I $G(BGPMUT)'="H" D
