...
PRINT ;EP
 ...
 N VALM,VALMHDR
 D HDR,START^BIREPQ2(BIQDT,.BICC,.BIHCF,.BICM,.BIBEN,BIHPV)
 ;
...
HDR ;EP
 ;---> Header code
 D HEAD^BIREPQ2(BIQDT,.BICC,.BIHCF,.BICM,.BIBEN)
 Q
 ;
 ;
 ;----------
INIT ;EP
 ...
 W !!?10,"This may take some time.  Please hold on...",!
 D START^BIREPQ2(BIQDT,.BICC,.BIHCF,.BICM,.BIBEN,BIHPV)
...
DEQUEUE ;EP
 ...
 D HDR^BIREPQ1,START^BIREPQ2(BIQDT,.BICC,.BIHCF,.BICM,.BIBEN,BIHPV)
