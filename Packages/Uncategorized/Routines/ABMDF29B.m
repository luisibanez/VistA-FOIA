ABMDF29B ; IHS/ASDST/DMJ - ADA 2006 Dental Export -part 2 ;    
 ;;2.6;IHS Third Party Billing;**1,2,3,4**;NOV 12, 2009
...
INS ;Ins Info
 ...
 ..D SEL^ABMDE2X
 ..;start old code abm*2.6*1 HEAT2948
 ..;S $P(ABMF(15),U)=$P($P(ABMV("X2"),U),";",2)  ;(5)
 ..;Q:$G(ABMP("INS2"))=""
 ..;I $P($G(^AUTNINS(ABMP("INS2"),2)),U)="D" S $P(ABMF(15),U)=$P($G(^DPT(ABMP("PDFN"),0)),U)  ;(5)
 ..;S $P(ABMF(17),U)=$P(ABMV("X2"),U,7)  ;(6)
 ..;I $P($G(^AUTNINS(ABMP("INS2"),2)),U)="D" S $P(ABMF(17),U)=$P($G(^DPT(ABMP("PDFN"),0)),U,3)  ;(6)
 ..;end old code start new code HEAT2948
 ..Q:$G(ABMP("INS2"))=""
 ..;S $P(ABMF(15),U)=$P($P(ABMV("X2"),U),";",2)  ;(5)  ;HEAT8604
 ..S $P(ABMF(14),U)=$P($P(ABMV("X2"),U),";",2)  ;(5)  ;HEAT8604
 ..;S $P(ABMF(17),U)=$P(ABMV("X2"),U,7)  ;(6)  ;HEAT8604
 ..S $P(ABMF(16),U)=$P(ABMV("X2"),U,7)  ;(6)  ;HEAT8604
 ..I $P($G(^AUTNINS(ABMP("INS2"),2)),U)="P" D
 ...S ABMPIEN=$O(^AUPNPRVT(ABMP("PDFN"),11,"B",ABMP("INS2"),0))
 ...;S $P(ABMF(15),U)=$P($G(^AUPN3PPH($P($G(^AUPNPRVT(ABMP("PDFN"),11,ABMPIEN,0)),U,8),0)),U)  ;(5)  ;HEAT8604
 ...S $P(ABMF(14),U)=$P($G(^AUPN3PPH($P($G(^AUPNPRVT(ABMP("PDFN"),11,ABMPIEN,0)),U,8),0)),U)  ;(5)  ;HEAT8604
 ...;S $P(ABMF(17),U)=$P($G(^AUPN3PPH($P($G(^AUPNPRVT(ABMP("PDFN"),11,ABMPIEN,0)),U,8),0)),U,19)  ;(6)  ;HEAT8604
 ...S $P(ABMF(16),U)=$P($G(^AUPN3PPH($P($G(^AUPNPRVT(ABMP("PDFN"),11,ABMPIEN,0)),U,8),0)),U,19)  ;(6)  ;HEAT8604
 ..I $P($G(^AUTNINS(ABMP("INS2"),2)),U)="D" D
 ...;S $P(ABMF(15),U)=$P($G(^DPT(ABMP("PDFN"),0)),U)  ;(5)  ;HEAT8604
 ...S $P(ABMF(14),U)=$P($G(^DPT(ABMP("PDFN"),0)),U)  ;(5)  ;HEAT8604
 ...;S $P(ABMF(17),U)=$P($G(^DPT(ABMP("PDFN"),0)),U,3)  ;(6)  ;HEAT8604
 ...S $P(ABMF(16),U)=$P($G(^DPT(ABMP("PDFN"),0)),U,3)  ;(6)  ;HEAT8604
 ..;end new code HEAT2948
 ..S $P(ABMF(12),U,2)="X"  ;Other cov(4)
 ;S:$P($G(ABMF(13)),U,2)="" $P(ABMF(13),U)="X"  ;No other cov(4)  ;HEAT8604
 S:$P($G(ABMF(12)),U,2)="" $P(ABMF(12),U)="X"  ;No other cov(4)  ;HEAT8604
 ;S $P(ABMF(2),U)="X"  ;stmt/actual svcs (1)  ;HEAT8604
 S $P(ABMF(1),U)="X"  ;stmt/actual svcs (1)  ;HEAT8604
 ;I $P($G(^AUTNINS(ABMP("INS"),2)),"^")="D"&($P($G(^ABMDVTYP(ABMP("VTYP"),0)),U)["EPSDT") S $P(ABMF(3),U)="X"  ;EPSDT/Title 19(1)  ;HEAT8604
...
BNODES ; Bill nodes
 ...
 ;S $P(ABMF(5),U)=$P(ABM("B5"),U,8)  ;Prior Auth(2)  ;abm*2.6*1 HEAT6673
 S $P(ABMF(4),U)=$P(ABM("B5"),U,12)  ;Prior Auth(2)  ;abm*2.6*1 HEAT6673 and  abm*2.6*3 HEAT8604
 ;I $P(ABM("B9"),U)]"" S $P(ABMF(50),U,3)="X"  ;Occup. illness(45)  ;HEAT8604
 I $P(ABM("B9"),U)]"" S $P(ABMF(49),U,3)="X"  ;Occup. illness(45)  ;HEAT8604
ACCD ;Accident?
 I $P(ABM("B8"),U,3)'="" D
 .I "12"[$P(ABM("B8"),U,3) D  Q
 ..;S $P(ABMF(50),U,4)="X"  ;auto accident(45)  abm*2.6*3 HEAT8604
 ..S $P(ABMF(49),U,4)="X"  ;auto accident(45)  ;HEAT8604
 ..;S $P(ABMF(51),U)=$P(ABM("B8"),U,2)  ;acc. dt(46)  abm*2.6*3 HEAT8604
 ..S $P(ABMF(50),U)=$P(ABM("B8"),U,2)  ;acc. dt(46)  ;HEAT8604
 ..;S $P(ABMF(51),U,2)=$P($G(^DIC(5,$P(ABM("B8"),U,16),0)),"^",2)  ;acc. st(47)  abm*2.6*3 HEAT8604
 ..S $P(ABMF(50),U,2)=$P($G(^DIC(5,$P(ABM("B8"),U,16),0)),"^",2)  ;acc. st(47)  ;HEAT8604
 .I "5"[$P(ABM("B8"),U,3) D  Q
 ..;S $P(ABMF(50),U,5)="X"  ;other accident(45)  abm*2.6*3 HEAT8604
...
FSYM I $P(ABM("B7"),U,4)="Y" D  ;ROI
 .;S $P(ABMF(46),U)="SIGNATURE ON FILE"  ;(36)  abm*2.6*3 HEAT8604
 .S $P(ABMF(45),U)="SIGNATURE ON FILE"  ;(36)  ;HEAT8604
 .;S $P(ABMF(46),U,2)=DT  ;(36)  ;abm*2.6*1 HEAT5760
 .S $P(ABMF(45),U,2)=$P(ABM("B7"),U,11)  ;(36)  ;abm*2.6*1 HEAT5760 and abm*2.6*3 HEAT8604
 I $P(ABM("B7"),U,5)="Y" D  ;AOB
 .;S $P(ABMF(50),U)="SIGNATURE ON FILE"  ;(37)  ;abm*2.6*2 FIXPMS10006
 .;S $P(ABMF(50),U,2)=DT  ;(37)  ;abm*2.6*1 HEAT5760
 .;S $P(ABMF(50),U,2)=$P(ABM("B7"),U,12)  ;(37)  ;abm*2.6*1 HEAT5760  ;abm*2.6*2 FIXPMS10006
 S $P(ABMF(49),U)="SIGNATURE ON FILE"  ;(37)  ;abm*2.6*2 FIXPMS10006 and abm*2.6*3 HEAT8604
 ;S $P(ABMF(49),U,2)=$S($G(ABMPDT)="O":$P($G(^ABMDTXST(DUZ(2),$P(^ABMDBILL(DUZ(2),ABMP("BDFN"),1),U,7),0)),U),1:DT)  ;(37)  ;abm*2.6*1 HEAT5760  ;abm*2.6*2 FIXPMS10006 and abm*2.6*3 HEAT8604  abm*2.6*4 HEAT17615
 ...
 ;I ABMP("BTYP")=111 S $P(ABMF(44),U,2)="X"  ;Hosp(38)  abm*2.6*3 HEAT8604
 I ABMP("BTYP")=111 S $P(ABMF(43),U,2)="X"  ;Hosp(38)  ;HEAT8604
 ;I $$POS^ABMERUTL=32 S $P(ABMF(44),U,3)="X"  ;EFC(38)  abm*2.6*3 HEAT8604
 I $$POS^ABMERUTL=32 S $P(ABMF(43),U,3)="X"  ;EFC(38)  ;HEAT8604
 ;I $$POS^ABMERUTL'=32,(ABMP("BTYP")'=111) S $P(ABMF(44),U)="X"  ;Provider office(dflt)(38)  abm*2.6*3 HEAT8604
 I $$POS^ABMERUTL'=32,(ABMP("BTYP")'=111) S $P(ABMF(43),U)="X"  ;Provider office(dflt)(38)  ;HEAT8604
 ;S $P(ABMF(44),U,5)=$P($G(ABM("B4")),U,3)  ;Radiographs(39)  abm*2.6*3 HEAT8604
 S $P(ABMF(43),U,5)=$P($G(ABM("B4")),U,3)  ;Radiographs(39)  ;HEAT8604
 ;S $P(ABMF(44),U,6)=$P($G(ABM("B9")),U,18)  ;Oral Images(39)  abm*2.6*3 HEAT8604
 S $P(ABMF(43),U,6)=$P($G(ABM("B9")),U,18)  ;Oral Images(39)  ;HEAT8604
 ;S $P(ABMF(44),U,7)=$P($G(ABM("B9")),U,19)  ;Models(39)  abm*2.6*3 HEAT8604
 S $P(ABMF(43),U,7)=$P($G(ABM("B9")),U,19)  ;Models(39)  ;HEAT8604
XRAY ;#/X-rays included
ORTHO ;Ortho. Related?
 ;S $P(ABMF(46),U,$S($P(ABM("B4"),U,4):4,1:3))="X"  ;(40)  abm*2.6*3 HEAT8604
 S $P(ABMF(45),U,$S($P(ABM("B4"),U,4):4,1:3))="X"  ;(40)  ;HEAT8604
 ; Ortho. Placement Dt
 ;I $P(ABM("B4"),U,4) S $P(ABMF(46),U,5)=$P(ABM("B4"),U,5)  ;(41)  abm*2.6*3 HEAT8604
 I $P(ABM("B4"),U,4) S $P(ABMF(45),U,5)=$P(ABM("B4"),U,5)  ;(41)  ;HEAT8604
 ;I $P(ABM("B4"),U,13) S $P(ABMF(48),U)=$P(ABM("B4"),U,13)  ;(42)  abm*2.6*3 HEAT8604
 I $P(ABM("B4"),U,13) S $P(ABMF(47),U)=$P(ABM("B4"),U,13)  ;(42)  ;HEAT8604
PROTH ;Proth. Included?
 ;S $P(ABMF(48),U,$S($P(ABM("B4"),U,6):3,1:2))="X"  ;(43)  abm*2.6*3 HEAT8604
 S $P(ABMF(47),U,$S($P(ABM("B4"),U,6):3,1:2))="X"  ;(43)  ;HEAT8604
 ; Prior Placement Dt
 ;I $P(ABM("B4"),U,6) S $P(ABMF(48),U,4)=$P(ABM("B4"),U,7)  ;(44)  abm*2.6*3 HEAT8604
 ...
 ;S $P(ABMF(23),U,5)=ABMBIL_"-"_ABMSFX_" "_ABMHRN  ;Pt ID(23)  abm*2.6*3 HEAT8604
 S $P(ABMF(22),U,5)=ABMBIL_"-"_ABMSFX_" "_ABMHRN  ;Pt ID(23)  ;HEAT8604
 I $D(^ABMDBILL(DUZ(2),ABMP("BDFN"),61,0)) D
 .S ABMIEN=0
 .;S ABMLINE=40  ;abm*2.6*4 HEAT8604
 .S ABMLINE=39  ;abm*2.6*4 HEAT8604
 .;F  S ABMIEN=$O(^ABMDBILL(DUZ(2),ABMP("BDFN"),61,ABMIEN)) Q:+ABMIEN=0!(ABMLINE>42)  D  ;abm*2.6*4 HEAT8604
 .F  S ABMIEN=$O(^ABMDBILL(DUZ(2),ABMP("BDFN"),61,ABMIEN)) Q:+ABMIEN=0!(ABMLINE>41)  D  ;abm*2.6*4 HEAT8604
 ..S ABMF(ABMLINE)=$G(^ABMDBILL(DUZ(2),ABMP("BDFN"),61,ABMIEN,0))
 ..S ABMLINE=ABMLINE+1
 Q
PAT ;
 S ABM("P0")=^DPT(ABMP("PDFN"),0)  ;0 node pt file
 ;S ABMF(18)=$P(ABM("P0"),U)  ;Name(20)  ;HEAT8604
 S ABMF(17)=$P(ABM("P0"),U)  ;Name(20)  ;HEAT8604
 S ABM("P11")=$G(^DPT(ABMP("PDFN"),.11))
 ;S $P(ABMF(19),U,6)=$P(ABM("P11"),U)  ;Mailing addr(20)  ;HEAT8604
 S $P(ABMF(18),U,6)=$P(ABM("P11"),U)  ;Mailing addr(20)  ;HEAT8604
 ;S $P(ABMF(20),U)=$P(ABM("P11"),U,4)  ;Mailing-city(20)  ;HEAT8604
 S $P(ABMF(19),U)=$P(ABM("P11"),U,4)  ;Mailing-city(20)  ;HEAT8604
 ;S $P(ABMF(20),U)=$P(ABMF(20),U)_", "_$P(^DIC(5,$P(ABM("P11"),U,5),0),U,2)  ;Mailing-St(20)  ;HEAT8604
 S $P(ABMF(19),U)=$P(ABMF(19),U)_", "_$P(^DIC(5,$P(ABM("P11"),U,5),0),U,2)  ;Mailing-St(20)  ;HEAT8604
 ;S $P(ABMF(20),U)=$P(ABMF(20),U)_"  "_$P(ABM("P11"),U,6)  ;Mailing-Zip(20)  ;HEAT8604
 S $P(ABMF(19),U)=$P(ABMF(19),U)_"  "_$P(ABM("P11"),U,6)  ;Mailing-Zip(20)  ;HEAT8604
 ;S $P(ABMF(23),U,2)=$P(ABM("P0"),U,3)  ;dob(21)  ;HEAT8604
 S $P(ABMF(22),U,2)=$P(ABM("P0"),U,3)  ;dob(21)  ;HEAT8604
 ;I $P(ABM("P0"),U,2)="M" S $P(ABMF(23),U,3)="X"  ;sex-male(22)  ;HEAT8604
 I $P(ABM("P0"),U,2)="M" S $P(ABMF(22),U,3)="X"  ;sex-male(22)  ;HEAT8604
 ;E  S $P(ABMF(23),U,4)="X"  ;sex-female(22)  ;HEAT8604
...
PRV ;
 ...
 .D SELBILL^ABMDE4X
 .D PAYED^ABMERUTL
 .;S $P(ABMF(55),U,2)=$P(ABM("A"),U)  ;(53)  ;HEAT8604
 .S $P(ABMF(54),U,2)=$P(ABM("A"),U)  ;(53)  ;HEAT8604
 .;S $P(ABMF(55),U,3)=+$P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),1)),U,5)  ;(53)  ;HEAT8604
 .;S $P(ABMF(54),U,3)=$S($G(ABMPDT)="O":$P($G(^ABMDTXST(DUZ(2),$P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),1)),U,7),0)),U),1:DT)  ;(53)  ;abm*2.6*2 FIXPMS10006 and   ;HEAT8604  ;abm*2.6*4 HEAT17615
 ...
 .;S $P(ABMF(57),U,2)=$S($P($$NPI^XUSNPI("Individual_ID",$P(ABM("A"),U,2)),U)>0:$P($$NPI^XUSNPI("Individual_ID",$P(ABM("A"),U,2)),U),1:"")  ;Dent NPI (54)  ;HEAT8604
 ...
 .;S $P(ABMF(60),U,2)=$$SLN^ABMEEPRV($P(ABM("A"),U,2))  ;Dent Lic(55)  ;HEAT8604
 .S $P(ABMF(59),U,2)=$$SLN^ABMEEPRV($P(ABM("A"),U,2))  ;Dent Lic(55)  ;HEAT8604
 .;S $P(ABMF(57),U,3)=$$SLN^ABMEEPRV($P(ABM("A"),U,2))  ;(55)  ;HEAT8604
 .S $P(ABMF(56),U,3)=$$SLN^ABMEEPRV($P(ABM("A"),U,2))  ;(55)  ;HEAT8604
 .;S $P(ABMF(61),U,4)=ABM("PNUM")  ;Prov#(58)  ;HEAT8604
 .S $P(ABMF(60),U,4)=ABM("PNUM")  ;Prov#(58)  ;HEAT8604
 .;S $P(ABMF(61),U,4)=ABM("PNUM")  ;Prov#(58)  ;HEAT8604
 .S $P(ABMF(60),U,4)=ABM("PNUM")  ;Prov#(58)  ;HEAT8604
 .;S $P(ABMF(61),U,2)=ABM("INUM")  ;loc id(52a)  ;HEAT8604
 .S $P(ABMF(60),U,2)=ABM("INUM")  ;loc id(52a)  ;HEAT8604
 .;S $P(ABMF(61),U,2)=ABM("INUM")  ;loc id(52a)  ;HEAT8604
 .S $P(ABMF(60),U,2)=ABM("INUM")  ;loc id(52a)  ;HEAT8604
 .;S $P(ABMF(61),U,3)=$P($G(^VA(200,$P(ABM("A"),U,2),.13)),U,2)  ;off. phone(57)  ;HEAT8604
 .S $P(ABMF(60),U,3)=$P($G(^VA(200,$P(ABM("A"),U,2),.13)),U,2)  ;off. phone(57)  ;HEAT8604
 .;S $P(ABMF(61),U,3)=$P($G(^VA(200,$P(ABM("A"),U,2),.13)),U,2)  ;off. phone(57)  ;HEAT8604
 .S $P(ABMF(60),U,3)=$P($G(^VA(200,$P(ABM("A"),U,2),.13)),U,2)  ;off. phone(57)  ;HEAT8604
 .;I $P(ABMF(61),U,3)="" S $P(ABMF(61),U,3)=$P($G(^AUTTLOC(ABMP("LDFN"),0)),U,11)  ;loc phone(57)  ;HEAT8604
 .I $P(ABMF(60),U,3)="" S $P(ABMF(60),U,3)=$P($G(^AUTTLOC(ABMP("LDFN"),0)),U,11)  ;loc phone(57)  ;HEAT8604
 .;I $P(ABMF(61),U,3)="" S $P(ABMF(61),U,3)=$P($G(^AUTTLOC(ABMP("LDFN"),0)),U,11)  ;loc phone(57)  ;HEAT8604
 .I $P(ABMF(60),U,3)="" S $P(ABMF(60),U,3)=$P($G(^AUTTLOC(ABMP("LDFN"),0)),U,11)  ;loc phone(57)  ;HEAT8604
 .;S $P(ABMF(58),U)=$$PTAX^ABMEEPRV($P(ABM("A"),U,2))  ;specialty(tax. code)(56a)  ;HEAT8604
