BGOVIMM ;IHS/BAO/TMD - IMMUNIZATION mgt   ;02-Feb-2010 16:04;MGH
...
IMMTOP() Q $O(^AUTTEDT("B","IM-IMMUNIZATION INFORMATION",0))
...
SET(RET,INP) ;EP
 ...
 S $P(ARG,V,21)=VOL
 I 'HIST D  Q:RET
 .S ICD=$$IMMICD(TYPE,VIEN,1),CPT=$$IMMCPT(TYPE,VIEN,1)
 .S:ICD<0 RET=ICD
 .S:CPT<0 RET=CPT
