...
20 ;PWK01 - Report Type Code
 ;S ABMR("PWK",20)=$P($G(^ABMDCODE($P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),71,ABM71IEN,0)),U),0)),U)  ;abm*2.6*1 HEAT6439 ;5010 837p
 S ABMR("PWK",20)="EB" ;5010 837P
 Q
30 ;PWK02 - Report Transmission Code
 ;S ABMR("PWK",30)="" ;5010 837P
 ;S ABMR("PWK",30)=$P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),71,ABM71IEN,0)),U,2)  ;abm*2.6*1 HEAT6439 ;5010 837p
...
60 ;PWK05 - Identification Code Qualifier
 S ABMR("PWK",60)=""
 ;S ABMR("PWK",60)="AC"  ;abm*2.6*1 HEAT6439  ;abm*2.6*2 ;5010 837p
 ;S ABMR("PWK",30)="FT" ;5010 837P
 ;I $P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),71,ABM71IEN,0)),U,3)'="" S ABMR("PWK",60)="AC"  ;abm*2.6*2 ;5010 837p
 ;S ABMR("PWK",30)="FT" ;5010 837P
 Q
70 ;PWK06 - Identification Code
 S ABMR("PWK",70)=""
 ;S ABMR("PWK",70)=$P($G(^ABMDBILL(DUZ(2),ABMP("BDFN"),71,ABM71IEN,0)),U,3)  ;abm*2.6*1 HEAT6439 ;5010 837P
 Q
