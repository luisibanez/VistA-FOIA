...
P1 ;Write individual measure
 ...
 D S^BGPMUDEL(X,1,1)
 S X="# w/normal BMI/followup"_U_$P(STRING1,U,9)_U_$P(STRING1,U,12)_U_$P(STRING2,U,9)_U_$P(STRING2,U,12)_U_PRD4_U_$P(STRING3,U,9)_U_$P(STRING3,U,11)_U_PRN4
 D S^BGPMUDEL(X,2,1)
...
BP2 ;Do the Details
 ...
 I BGPLIST="N"!(BGPLIST="A") D
 .K BGPARR
 .D PTLSORT^BGPMUUTL(.BGPARR,"^TMP(""BGPMU0013"","_$J_",""PAT"",""C"",""DEN"")")
 .S PT=0 F  S PT=$O(BGPARR(PT)) Q:PT=""  D
 ..S PTCT=PTCT+1
 ..S NODE=$G(BGPARR(PT))
 ..D DATA2(NODE)
