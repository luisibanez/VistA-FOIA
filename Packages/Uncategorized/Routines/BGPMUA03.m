BGPMUA03 ; IHS/MSC/MGH - MI measure NQF0031 ;01-Mar-2011 15:37;MGH
...
ENTRY ;EP
 ...
 N BGPN1,BGPN3,RETVAL,BGPMUMAM,BGPMAS,AENC,BENC,BGPBIRTH,BGPMAM,BGPMAM2,BGPMAM3
 ...
 S FIRST=END-1 F  S FIRST=$O(^AUPNVSIT("AA",DFN,FIRST)) Q:FIRST=""!(FIRST>START2Y)!(+VIEN)  D
 ...
 .I +BGPMAM2 D
 ..I STRING2="" S STRING2="MAMP:"+$P(BGPMAM2,U,2),BGPNSTR=$P(BGPMAM2,U,4)_";"_$P($P(BGPMAM2,U,3),".",1)
 ..I STRING2'="" S STRING2=STRING2_";MAMP:"+$P(BGPMAM2,U,2),BGPNSTR=$P(BGPMAM2,U,4)_";"_$P($P(BGPMAM2,U,3),".",1)
 .I +BGPMAM3 D
 ..I STRING2="" S STRING2="MAMD:"+$P(BGPMAM3,U,2),BGPNSTR=$P(BGPMAM3,U,4)_";"_$P($P(BGPMAM3,U,3),".",1)
 ..I STRING2'="" S STRING2=STRING2_";MAMD:"+$P(BGPMAM3,U,2),BGPNSTR=$P(BGPMAM3,U,4)_";"_$P($P(BGPMAM3,U,3),".",1)
...
CPT(CODE) ;See if the patient has the CPT codes for mastectomy
 N VAL,TAX,FOUND,VISIT,CPT,MDATE,CPTCODE,MOD1,MOD2,BGPX,CNT
 S VAL=0,CNT=0
...
ICD0(CODE) ;See if the patient has the CPT codes for mastectomy
 N VAL,TAX,FOUND,VISIT,ICD0,MDATE,ICDCODE,MOD1,MOD2,BGPX,CNT,DATA
 S VAL=0,CNT=0,DATA=0
