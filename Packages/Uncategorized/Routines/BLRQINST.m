...
BULTX ;BULLETIN SENT TO LAB  IF PCC ERROR IN FILING
 ...
 ;I $G(BLRACC) S XMB(5)=BLRACC
 S XMB(5)=$G(BLRACC)
 I $G(BLRTLAB) S XMB(6)=$P($G(^LAB(60,BLRTLAB,0)),U)
...
EOJ ;
 ...
 K BLRDUZ,BLRTNAME,BLRXFLG,BLRTRAN,BLRSDI,BLRMOD,BLRL,XMB,BLRPCC,BLRVIEN,BLRPAREN,BLRRFH,BLRRFL,U,BLRLTA,BLRLTP,BLRQUIET,BLRDH
 Q
