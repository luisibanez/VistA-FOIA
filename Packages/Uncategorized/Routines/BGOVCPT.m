BGOVCPT ; IHS/BAO/TMD - Manage V CPT ;03-Feb-2011 13:27;DU
 ;;1.1;BGO COMPONENTS;**1,3,4,5,6,8**;Mar 20, 2007
 ;---------------------------------------------
TIUSTR() ;EP
 N X,Y
...
SET(RET,INP) ;EP
 ...
 I EVNTDT<2950101 S CHKDT=2950101
 E  S CHKDT=EVNTDT
 ...
 Q:RET
 I 'VFIEN D  Q:RET
 .I EVNTDT<2950101 S APCDOVR=1   ;IHS/MSC/MGH auto store if old data
