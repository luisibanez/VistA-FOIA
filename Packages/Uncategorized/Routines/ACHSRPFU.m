ACHSRPFU ; IHS/OIT/FCJ - PRINT CHS FORM AND DATA 3 OF 3;JUL 10, 2008
...
INSOTH1 ; other ins Box 3.h
 S N="",I=0
 I $D(I("B")) F  S N=$O(I("B",N)) S I=I+1 Q:(N'?1N.N)!(I>3)  D
 .S $P(^TMP("ACHSPO",$J,ACHSDIEN,ACHSTIEN,"I"),U,8+I)=$P(I("B",N),U)   ;INSURANCE TYPE
 .S $P(^TMP("ACHSPO",$J,ACHSDIEN,ACHSTIEN,"I"),U,9+I)=$P(I("B",N),U,2)   ;INSURANCE EFFECTIVE DATE
 ;
FIN ;
