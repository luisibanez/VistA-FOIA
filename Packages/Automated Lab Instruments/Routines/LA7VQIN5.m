LA7VQIN5 ;VA/DALOI/JMC - Process Incoming UI Msgs, continued ;JUL 06, 2010 3:14 PM
...
OBX ;
 ...
 I $G(LA7ORS)="" S LA7ORS="F"  ;ihs/cmi/maw 8/27/2010 if Quest does not send a status flag
 ;
 ...
 ;
 I LA7MTYP="ORM",$G(LA7696)>0 D ORESULTS^LA7VQN5A
 ;
 Q
 ;
 ;
PROCESS ; Process results for a given test code
 ...
 D REFRNG^LA7VQN5A($$P^LA7VHLU(.LA7SEG,8,LA7FS))
 ;
 ...
 D ABFLAG^LA7VQN5A($$P^LA7VHLU(.LA7SEG,9,LA7FS))
 ;
 ; Store units
 I LA7UNITS'="" D
 ...
 D PRDID^LA7VQN5A($$P^LA7VHLU(.LA7SEG,16,LA7FS),LA7SFAC,LA7CS)
 ;
 ; Store equipment instance identifier
 I LA7EII'="" D EII^LA7VQN5A
 ;
