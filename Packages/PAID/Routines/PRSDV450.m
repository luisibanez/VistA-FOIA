PRSDV450 ;HISC/MGD-VIEW PAID EMPLOYEE DATA ;09/05/2003
 ;;4.0;PAID;**2,82**;Sep 21, 1995
EN1 ;HRM entry
 S LIMIT=10 D PTBL^PRSDVTBL G EMP
EN2 ;Fiscal entry
 S LIMIT=12 D FTBL^PRSDVTBL
...
SAN W ! K DIR,DIRUT,DIROUT,DTOUT,DUOUT
 ...
 S IOF=IOFSAV
 F L="CATEGORY","CCORG","CLNGTH","DA","DASHES","DATETIME","VAL(","DS","LPP","NAME","PAGE","PRNTORDR(","SSN","STATION","TAB","TLU" S ZTSAVE(L)=""
...
KILL2 K CATEGORY,CCORG,CHOICE,CLNGTH,DA,DASHES,DATETIME,DS,FIRST,LAB,LIMIT,LPP
 K NAME,NOL,PAGE,PRTC,SSN,STATION,TAB,TLU,LOOP,ZTREQ,%,%I
 Q
