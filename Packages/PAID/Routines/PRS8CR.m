PRS8CR ;HISC/MRL-DECOMPOSITION, CREATE STRING ;8/23/01
 ;;4.0;PAID;**2,6,45,69**;Sep 21, 1995
 ;
 ...
 S S="33333333333333333333333333333333344362323333333"
 S E(1)="ANSKWDNOAURTCECUUNNANBSPSASBSCDADBDCTFOAOBOCYAOKOMRARBRCHAHBHCPTPAONYDHDVCEA  EB  TATCFAFCADNT"
 S E(2)="ALSLWPNPABRLCTCOUSNRNSSQSESFSGDEDFDGTGOEOFOGYEOSOURERFRGHLHMHNPHPBCLYHHOVSEC  ED  TBTDFBFDAFNH"
 ...
 F J=1,2 F I=1:1:38,40,42,43,44,45,46,47 S X=+$P(WK(J),"^",I) I X]"" D
