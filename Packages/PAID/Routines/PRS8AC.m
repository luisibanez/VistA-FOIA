PRS8AC ;HISC/MRL-DECOMPOSITION, ACTIVITY STRING ;01/22/04
 ;;4.0;PAID;**40,45,54,52,69,75,90,96**;Sep 21, 1995
 ;
 ...
 .I ("Eocb"[VAR1!(VAR1="O"&'$E(DAYH,T)))&("^^10^11^12^13^15^16^"[("^"_$P(V,"^",4)_"^"))!(VAR1=5&("ALSRUFGD"[VAR))!(VAR1=4&(TYP["P"!(TYP["I"&(TYP["N"!(TYP["H"!($$HYBRID^PRSAENT1($G(DFN)))))))&("^7^9^11^12^14^"[("^"_$P(V,"^",4)_"^"))) D
