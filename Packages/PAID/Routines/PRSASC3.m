PRSASC3 ; HISC/REL-Supervisor Approve Prior PP Actions ;11/29/95  13:40
...
APP ; Approve PP Action
 ...
 I NOD="AXS" S $P(^PRST(458,PPI,"E",DFN,"X",AUN,0),"^",8,9)=DUZ_"^"_NOW
...
AT ; Approve time
 ...
 I AUC S L2=0 F L1=0,1,2,10,3,4 S L2=L2+1 S Z=$G(^PRST(458,PPI,"E",DFN,"X",AUN,L2)) K ^PRST(458,PPI,"E",DFN,"D",DAY,L1) I Z'="" S ^(L1)=Z
 Q
