PRS8VW2 ;HISC/MRL,RTK-DECOMPOSITION, VIEW RESULTS ;09/27/01
 ;;4.0;PAID;**6,32,34,45,69**;Sep 21, 1995
 ; 
...
CON ; --- convert to proper format
 ...
 Q
 ;
 ; See description of similar table in routine PRS8VW1 for 
...
Y ;;A:23:3^D:35:4^E:23:3^H:35:4
 ;
TYP ; literal values of acitivites (actual name)
 ;;Annual Leave
 ;;Sick Leave
 ;;Leave Without Pay
 ;;Non-Pay Time
