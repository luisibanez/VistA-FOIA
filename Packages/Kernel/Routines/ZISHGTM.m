%ZISH	;ISF/AC,RWF - GT.M for VMS/Unix Host file Control ;8:06 AM  31 Aug 2010
	;;8.0;KERNEL;**275,306,385,250004**;Jul 10, 1995;Build 8;WorldVistA 30-June-08
	;
...
DEFDIR(DF)	;ef. Default Dir and frmt
	...
	S:DF="" DF=$G(^XTV(8989.3,1,"DEV")),DF=$P(DF,"^",$S($$PRI^%ZOSV<2:1,1:2)) ;P254004
	;Old code
