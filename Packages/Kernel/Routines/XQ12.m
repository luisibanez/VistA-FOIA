XQ12	;SEA/LUKE - MENU MANAGER UTILITIES ;11/14/2002  11:55
	;;8.0;KERNEL;**9,20,46,157,253,*LOCAL**;Jul 10, 1995;Build 1
	;
...
LOGOPT	;Option audit
	...
	S I=1 I XQAUDIT'=1 S I=0 F J=1:2 S K1=$P(XQAUDIT,U,J),K2=$P(XQAUDIT,U,J+1) Q:'$L(K1)!I  I K1=2&(K2=XQY)!(K1=3&($E($P(XQY0,U,1),1,$L(K2))=K2)) S I=1
	Q:'I
	D GETENV^%ZOSV S XUVOL=$P(Y,U,2)
	L +^XUSEC(19,0):10 S I=^XUSEC(19,0)
	F XQLTL=%:.00000001 Q:'$D(^XUSEC(19,XQLTL,0))
	S ^XUSEC(19,XQLTL,0)=XQY_U_DUZ_U_$I_U_$J_"^^"_XUVOL,$P(^XUSEC(19,0),U,3,4)=XQLTL_"^"_($P(I,U,4)+1)
	L -^XUSEC(19,0)
	Q
	;
