ZOSFONT ;SFISC/AC - SETS UP ^%ZOSF for Cache for NT/VMS ;10/19/06  14:01
 ;;8.0;KERNEL;**1005,1007,1016**;APR 1, 2003 ;Build 5
 ;;8.0;KERNEL;**34,104,365**;JUL 10, 1995;Build 5
 ;For Cache versions 3.2, 4 and 5
 ;THIS ROUTINE CONTAINS AN IHS MODIFICATION BY BWF
 ; Added DUZ and XUMGR checks to RESJOB node.
...
Z ;;
 ...
 ;;D ^%RD
 ;;RESJOB
 ;;Q:'$D(DUZ)  Q:'$D(^XUSEC("XUMGR",+DUZ))  N OLD S OLD=$ZNSPACE ZNSPACE "%SYS" D ^RESJOB ZNSPACE OLD Q
 ;;RM
 ;;I $G(IOT)["TRM" U $I:X
 ;;RSEL;;ROUTINE SELECT
