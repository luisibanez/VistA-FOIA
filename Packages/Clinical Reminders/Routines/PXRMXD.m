PXRMXD ; SLC/PJH - Reminder Due reports DRIVER ;10/07/2004
...
START ; Arrays and strings
 ...
 N DBDUZ,STORETMP,PXRMLIST,PXRMLIS1,Y
 ;
...
REP ;
 ...
 .D START^PXRMXTA("JOB^PXRMXD") K DUOUT,DIRUT,DTOUT
 ;
