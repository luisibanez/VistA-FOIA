PXRMEVFI ; SLC/PKR - Driver for finding evaluation. ;12/01/2004
...
EVAL(DFN,DEFARR,FIEVAL) ;Evaluate the findings by group using the "E"
 ...
 . I ENODE="YTT(601," D EVALFI^PXRMMH(DFN,.DEFARR,ENODE,.FIEVAL) Q
...
EVALPL(DEFARR,FINUM,PLIST) ;Create a patient list for a regular
 ...
 D EVALPL^PXRMTERM(.FINDPA,.TERMARR,PLIST)
 Q
 ;
