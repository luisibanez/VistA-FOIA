PXRMPTDF ; SLC/PKR/PJH - Reminder Inquiry print template routines. ;12/06/2004
 ;;2.0;CLINICAL REMINDERS;;Feb 04, 2005
 ;
 ;================================================
PFIND ;Print the reminder definition finding multiple.
 N DIWF,FIELD,FILENUM,FINDING,FIND0,FIND3,FINDNAM,FL,HFIEN,IEN1,IND
 N INT,LEN,PAD,PADS,PARRAY,RJC,RFIND,RTERM,SCNT,SIEN,STAT0
