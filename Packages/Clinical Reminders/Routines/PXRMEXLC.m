...
CDISP(IEN) ;Format component list for display.
 ...
 .. S EOKTI=FOKTI
 .. S PT01=$P(TEMP,U,1)
 .. S EXISTS=$S(FILENUM=0:$$EXISTS^PXRMEXCF(PT01),1:$$EXISTS^PXRMEXIU(FILENUM,PT01))
...
INSCHR(NUM,CHR) ;Return a string of NUM characters (CHR).
 ...
 ;======================================================
DREPL(DLG,LEV) ;
 N DDATA,DDLG,DEND,DNAM,DREP,DSEQ,DSTRT,IND,JND
 ...
 S ^TMP("PXRMEXLD",$J,"IDX",NLINE,NSEL)=""
 D DLINE^PXRMEXLD(DNAM,LEV,"1(R)") Q:DREP'=""
 I $D(^TMP("PXRMEXTMP",$J,"DMAP",DNAM)) D DCMP^PXRMEXLD(DNAM,LEV,"R")
 Q
