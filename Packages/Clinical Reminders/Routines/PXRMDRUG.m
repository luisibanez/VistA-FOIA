PXRMDRUG ; SLC/PKR - Handle drug findings. ;11/22/2004
 ;;2.0;CLINICAL REMINDERS;;Feb 04, 2005
 ;
 ;===============================================
DEVAL(DFN,FINDPA,DEFARR,FINDING,DRUGIEN,POI,FIEVAL) ;Evaluate a drug
 ;finding.
 N DTERM,FIEVT,RXTYL
 ...
 M FIEVAL=FIEVT(1)
 I FIEVAL S FIEVAL("FINDING")=DRUGIEN_";PSDRUG(",FIEVAL("DISPENSE DRUG")=DRUGIEN
 Q
 ;
 ;===============================================
EVALFI(DFN,DEFARR,ENODE,FIEVAL) ;Evaluate drug findings.
 ...
 .. K FIEVT
 .. D DEVAL(DFN,.FINDPA,.DEFARR,FINDING,DRUGIEN,POI,.FIEVT)
