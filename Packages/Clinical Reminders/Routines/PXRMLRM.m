PXRMLRM ; SLC/PKR/PJH - Extract/Transmission Management ;07/02/2002
...
BLDLIST ;Build workfile
 ...
 Q
 ;
LIST(RLIST,IEN,LRTYP) ;Build a list of extract parameter entries.
...
LIT(VIEW) ;Header text depnds on view
 Q $S(PXRMTYP=3:"Rule Sets",PXRMTYP=1:"Finding Rules",1:"Unknown")
 ;
INIT ;Init
 S VALMCNT=0
 Q
...
HELP(CALL) ;General help text routine
 ...
 .S HTEXT(3)="Select S to edit rule sets. A rule set may contain either "
 .S HTEXT(4)="finding list rules or patient list rules or both. These "
 .S HTEXT(5)="component list rules must be created before the rule set "
 .S HTEXT(6)="can be constructed."
 ;
...
VIEW ;Select view
 ...
 ;AGP CHANGE FOR REMINDER RULES
 S DIR(0)=DIR(0)_"R:Reminder Rule;"
 S DIR(0)=DIR(0)_"S:Rule Set;"
 ;S DIR(0)=DIR(0)_"O:Report Output Rule;"
