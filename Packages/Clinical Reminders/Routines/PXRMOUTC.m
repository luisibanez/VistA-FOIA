PXRMOUTC ; SLC/PKR - Clinical Maintenance output. ;12/30/2004
...
CM(DEFARR,PXRMPDEM,PCLOGIC,RESLOGIC,RESDATE,FIEVAL) ;Prepare the 
 ...
 . I FTYPE="RES" D LOGIC^PXRMFNFT(PXRMPDEM("DFN"),RESLOGIC,FTYPE,"D",.DEFARR,.FIEVAL,.NTXT)
...
FREQ(DEFARR,NTXT,TEXT) ;Display the frequency information.
 ...
 . I TEMP'="" D
 .. S TEMP="Due every "_$$FMTFREQ^PXRMAGE($P(TEMP,U,1))_$$FMTAGE^PXRMAGE($P(TEMP,U,2),$P(TEMP,U,3))
 .. S TEXT="Frequency: "_TEMP_"."
 .. D ADDTXT^PXRMOUTU(1,PXRMRM,.NTXT,TEXT)
 Q
 ;
 ;================================================
