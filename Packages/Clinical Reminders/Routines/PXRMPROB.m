PXRMPROB ; SLC/PKR - Code for Problem List. ;11/30/2004
...
FPDAT(DFN,TAXARR,NGET,SDIR,BDT,EDT,STATUSA,FLIST) ;Find data for a
 ...
 N BDTT,DAS,DATE,DEND,DS,DSAVE,DTT,EDTT,ICDP,IND,JND,LGT,LLT
 N NFOUND,NPRIO,NSTAT,PRIO,PRIOA,STAT,STATUSAT,TE,TS,TLIST
 ...
 ;problems if DT lies in the date range.
 I DT'<BDT,DT'>DEND S NPRIO=3,PRIOA(1)="C",PRIOA(2)="A",PRIOA(3)="U"
 ...
 .. I SDIR=-1,PRIO="C" S DS=DTT,LLT=0,LGT=DT
 .. I SDIR=1,PRIO'="C" S DS=BDTT,LLT=0,LGT=EDT
 .. I SDIR=1,PRIO="C" S DS=0,LLT=0,LGT=DT
 .. S ICDP=TS
