PXRMINDX ; SLC/PKR - Routines for utilizing the index. ;11/15/2004
...
FIEVAL(FILENUM,SNODE,DFN,ITEM,PFINDPA,FIEVAL) ;
 ...
 N BDT,CASESEN,COND,CONVAL,DAS,DATE,EDT,FIEVD,FLIST,ICOND,IEN,IND
 N NFOUND,NGET,NOCC,NP
 N SAVE,SDIR,SSFIND,STATOK,STATUSA,UCIFS,VSLIST
 ...
 I SSFIND D FPDATSS(FILENUM,SNODE,DFN,ITEM,NGET,SDIR,BDT,EDT,.NFOUND,.FLIST)
 ...
 .. I $P(FLIST(IND),U,3)="S" S FIEVAL(NP,"STOP DATE")=FIEVAL(NP,"DATE")
 .. M FIEVAL(NP)=FIEVD
...
FPDAT(FILENUM,SNODE,DFN,ITEM,NGET,SDIR,BDT,EDT,NFOUND,FLIST) ;Find patient
 ...
 ;
 ;================================================================
FPDATSS(FILENUM,SNODE,DFN,ITEM,NGET,SDIR,BDT,EDT,NFOUND,FLIST) ;Find patient
 ;data for findings that have a start and stop date. FLIST is returned 
 ;in date order, i.e., FLIST(1) is the most recent.
 N DAS,DATE,DONE,EDTT,OVERLAP,START,STOP
 S EDTT=$S(EDT[".":EDT+.0000001,1:EDT+.240001)
 S (DONE,NFOUND)=0
 ...
 .. S NFOUND=NFOUND+1,FLIST(NFOUND)=DAS_U_DATE_U_"S"
 .. I NFOUND=NGET S DONE=1 Q
 Q
 ;
 ;================================================================
STATUSOK(STATUSA,FIEVD) ;Return true if the status in FIEVD matches one in
 ...
 . S COND="I V="""_STATUSA(JND)_""""
 . S CONVAL=$$COND^PXRMCOND(0,COND,"",.FIEVD)
 . I CONVAL S OK=1 Q
 Q OK
 ;
