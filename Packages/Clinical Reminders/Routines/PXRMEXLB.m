PXRMEXLB ;SLC/PJH - Reminder Dialog Exchange. ;07/01/2004
...
DBUILD(IND,NITEMS,FILENUM) ;
 ...
 ..I $P(DNODE,";")'="801.412"&($P(DNODE,";",3)'["118~") Q
 ..S DNODE=$P(DNODE,";",3)
 ..;;Modified Exchange to handle dialogs with replacement dialogs
 ..I $E(DNODE,1,4)="118~" D
 ...S DNAM=$P(DNODE,"~",2) Q:DNAM=""
 ...S DLOC=$G(^TMP("PXRMEXTMP",$J,"DLOC",DNAM))
 ...S ^TMP("PXRMEXTMP",$J,"DREPL",DDLG)=DNAM_U_DLOC
 ..I $E(DNODE,1,4)'=".01~" Q
