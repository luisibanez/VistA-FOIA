...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 ...
 I $D(^(.361)) S %Z=^(.361) S %=$P(%Z,U,1) S:%]"" DE(19)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW=".32;15",DV="P23'X",DU="",DLB="NNTL-Bran. Ser.",DIFLD=.3296
 S DE(DW)="C3^DVBHCE5",DE(DW,"INDEX")=1
 S DU="DIC(23,"
 G RE
...
X18 S DVBSCR=1 D ^DVBHS5 S DVBJ2=1
 Q
19 D:$D(DG)>9 F^DIE17,DE S DQ=19,DW=".361;1",DV="SX",DU="",DLB="ELIGIBILITY STATUS",DIFLD=.3611
 S DE(DW)="C19^DVBHCE5"
