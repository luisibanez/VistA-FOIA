...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;19",DV="RP353'",DU="",DLB="FORM TYPE",DIFLD=.19
 S DE(DW)="C1^IBXSC63"
 S DU="IBE(353,"
 S X=$G(DIPA("FT1"))
 S Y=X
...
X4 D FTPRV^IBCEU5(DA)
 Q
5 S DQ=6 ;@62
6 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=6 D X6 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X6 S:IBDR20'["62" Y="@63"
 Q
7 D:$D(DG)>9 F^DIE17,DE S DQ=7,DW="U;5",DV="RFOX",DU="",DLB="IS THIS A SENSITIVE RECORD?",DIFLD=155
...
10 S DW="U;6",DV="RFOX",DU="",DLB="ASSIGNMENT OF BENEFITS",DIFLD=156
 S DQ(10,2)="S Y(0)=Y S Y=$S(Y="""":"""",""Yy1""[Y:""YES"",""Nn0""[Y:""NO"",1:"""")"
 G RE
...
X23 D RCD^IBCU1
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,D=0 K DE(1) ;42
 S DIFLD=42,DGO="^IBXSC66",DC="15^399.042IPA^RC^",DV="399.042MR*P399.2'",DW="0;1",DOW="REVENUE CODE",DLB="Select "_DOW S:D DC=DC_D
 S DU="DGCR(399.2,"
