IBXSC3 ; GENERATED FROM 'IB SCREEN3' INPUT TEMPLATE(#574), FILE 399;02/04/05
 D DE G BEGIN
DE S DIE="^DGCR(399,",DIC=DIE,DP=399,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGCR(399,DA,""))=""
 ...
 I $D(^("M")) S %Z=^("M") S %=$P(%Z,U,12) S:%]"" DE(22)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
X5 S DIPA("FT1")=$P($G(^DGCR(399,DA,0)),U,19)
 Q
6 S DQ=7 ;@5
7 D:$D(DG)>9 F^DIE17,DE S DQ=7,DW="0;19",DV="RP353'",DU="",DLB="FORM TYPE",DIFLD=.19
 S DE(DW)="C7^IBXSC3"
 S DU="IBE(353,"
 G RE
...
X10 W !,*7,"Must be a printable national form type"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="0;19",DV="RP353'",DU="",DLB="FORM TYPE",DIFLD=.19
 S DE(DW)="C11^IBXSC3"
 S DU="IBE(353,"
 S X=$G(DIPA("FT1"))
 S Y=X
...
22 D:$D(DG)>9 F^DIE17,DE S DQ=22,DW="M;12",DV="FXO",DU="",DLB="PRIMARY INSURANCE POLICY",DIFLD=112
 ...
 S DE(DW)="C22^IBXSC3",DE(DW,"INDEX")=1
 G RE
