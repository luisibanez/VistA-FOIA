IBXSC8 ; GENERATED FROM 'IB SCREEN8' INPUT TEMPLATE(#514), FILE 399;10/15/04
 D DE G BEGIN
...
X4 S:IBDR20'["82" Y="@83"
 Q
5 S DW="U1;4",DV="F",DU="",DLB="UB82 FORM LOCATOR 2",DIFLD=204
 G RE
X5 K:$L(X)>30!($L(X)<2) X
 I $D(X),X'?.ANP K X
 Q
...
X22 S:IBDR20'["88" Y="@89"
 Q
23 S DW="U;13",DV="FX",DU="",DLB="TREATMENT AUTHORIZATION CODE",DIFLD=163
 G RE
