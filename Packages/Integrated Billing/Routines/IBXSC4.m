IBXSC4 ; GENERATED FROM 'IB SCREEN4' INPUT TEMPLATE(#510), FILE 399;10/15/04
 D DE G BEGIN
...
X7 Q
8 S D=0 K DE(1) ;48
 S DIFLD=48,DGO="^IBXSC41",DC="3^399.048P^OT^",DV="399.048M*P399.1'",DW="0;1",DOW="SNF/SA CARE",DLB="Select "_DOW S:D DC=DC_D
 S DU="DGCR(399.1,"
...
X15 S:IBDR20'["46" Y="@47"
 Q
16 S D=0 K DE(1) ;41
 S DIFLD=41,DGO="^IBXSC42",DC="4^399.041IPA^OC^",DV="399.041M*P399.1'",DW="0;1",DOW="OCCURRENCE CODE",DLB="Select "_DOW S:D DC=DC_D
 S DU="DGCR(399.1,"
...
X18 S:IBDR20'["47" Y="@44"
 Q
19 S D=0 K DE(1) ;40
 S DIFLD=40,DGO="^IBXSC43",DC="1^399.04PA^CC^",DV="399.04M*P399.1'",DW="0;1",DOW="CONDITION CODE",DLB="Select "_DOW S:D DC=DC_D
 S DU="DGCR(399.1,"
...
X29 I $P(^DGCR(399,DA,0),U,19)=2 S Y="@49"
 Q
30 S D=0 K DE(1) ;47
 S DIFLD=47,DGO="^IBXSC44",DC="2^399.047PA^CV^",DV="399.047M*P399.1'",DW="0;1",DOW="VALUE CODE",DLB="Select "_DOW S:D DC=DC_D
 S DU="DGCR(399.1,"
