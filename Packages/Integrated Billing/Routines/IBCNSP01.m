IBCNSP01 ;ALB/AAS - INSURANCE MANAGEMENT - EXPANDED POLICY  ; 05-MAR-1993
 ;;2.0;INTEGRATED BILLING;**43,52,85,251**;21-MAR-94
...
VER ; -- Entered/Verfied Region
 N OFFSET,START
 S START=41+$G(IBLCNT),OFFSET=2
 I '$D(@VALMAR@(START-1)) D SET^IBCNSP(START-1,OFFSET,"  ")
...
RIDER ; -- Personal policy riders
 ...
 S START=53+$G(IBLCNT),OFFSET=2,IBL=0
 I '$D(@VALMAR@(START-1)) D SET^IBCNSP(START-1,OFFSET,"  ")
