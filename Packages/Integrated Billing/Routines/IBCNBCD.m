IBCNBCD ;ALB/ARH-Ins Buffer: display/compare buffer and existing ins ;1 Jun 97
 ;;2.0;INTEGRATED BILLING;**82,251**;21-MAR-94
 ;;Per VHA Directive 10-93-142, this routine should not be modified.
 ;
INS(IBBUFDA,IBINSDA) ; display a buffer entrys insurance company fields and an existing insurance company fields for comparison
 ...
 Q
 ;
GRP(IBBUFDA,IBGRPDA) ; display a buffer entrys group insurance fields and an existing group/plan's fields for comparison
 N IBEXTDA,IBFLD1,IBFLD2,X I '$G(IBBUFDA) Q
 ;
 ...
 Q
 ;
POLICY(IBBUFDA,IBPOLDA) ; display a buffer entrys patient policy fields and an existing patient policy's fields for comparison
