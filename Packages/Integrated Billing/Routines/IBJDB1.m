IBJDB1 ;ALB/CPM - BILLING LAG TIME REPORT ; 27-DEC-96
 ;;2.0;INTEGRATED BILLING;**69,80,100,118**;21-MAR-94
 ;
...
ENQ K ^TMP("IBJDB1",$J)
 ...
 ;
 D ^%ZISC
ENQ1 K IB,IBBDT,IBEDT,IBCK,IBN,IBN0,IBRPT,IBPAG,IBQ,IBRUN,IBX,IBX1,IBX2,IBX3
 K IBAUTH,IBDAT,IBDFN,IBNU,IBPTF,IBPOL,IBPOL1,IBTY,IBS,IBSEL,IBSEL1,IBCT
 K IBDIV,IBSORT,IBTL,IBCHK,IBDCHK,DFN,POP,VAUTD,ZTDESC,ZTRTN,ZTSAVE
 K DIROUT,DTOUT,DUOUT,DIRUT,%,%ZIS,D,X,X1,X2,Y,Y1,Z,Z1,Z2,Z3
 Q
 ;
