MAGUXRF ;WOIFO/SRR - Imaging MUMPS cross-references ; [ 06/20/2001 08:57 ]
...
SETPPXD5 ;#5:SET (PATIENT=X=DFN); #6:PX(PROCEDURE); #15:DT(PROCEDURE DATE/TIME)
 ...
 Q
 ;
SETUP5 ; Set up for for date/time proceedure field#15
...
SETDCM ; Set the cross reference for DICOM SERIES NUM
 ...
 Q
 ;
KILLDSN ; Kill the cross refernece for DICOM SERIES NUM
 N MAGDSN,MAGDIN
 I '$$BOTHNUM(.MAGDSN,.MAGDIN) Q
 S Z=+^MAG(2005,DA(1),1,DA,0)
