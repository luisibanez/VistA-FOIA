DIDTC ;SFISC/XAK-DATE/TIME OPERATIONS ;11:49 AM  2 Dec 2002 [ 12/09/2003  4:21 PM ]
 ;;22.0;VA FileMan;**14,36,71,117,1002**;Mar 30, 1999
...
YMD I %H[",0" S %=%H N %H S %H=%-1_",86400"
 D 7 S %=$P(%H,",",2) D S K %D,%M,%Y Q
