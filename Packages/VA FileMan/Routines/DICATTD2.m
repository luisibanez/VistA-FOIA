DICATTD2 ;SFISC/GFT ;10:13 AM  26 Jan 2001;NUMERIC FIELD [ 04/02/2003   8:25 AM ]
...
POST2 ;check NUMERIC
 ...
 S DICATTMN="Type a "_$P("number^Dollar amount",U,$$G(33)=1+1)_" between "_Y_" and "_L_", "_DD_" Decimal Digit"_$E("s",DD'=1)
