DICM ;SFISC/GFT,XAK,TKW-MULTIPLE LOOKUP FOR FLDS WHICH MUST BE TRANSFORMED ;5/8/00  12:56
 ;;22.0;VA FileMan;**4,20,31,40**;Mar 30, 1999
...
2 D D^DIC0 S %=D
 ...
 . D % N DIFILEI,DINDEX
 . S DIC(0)=$TR(DIC(0),"L"),X=$$OUT^DIALOGU(X,"UC") S:$G(DILONGX) DICR(DICR,"ORG")=X
 . D DIC Q
 ...
 . S %=D D % S (X,DICR(DICR,"ORG"))=$$OUT^DIALOGU(X,"UC")
 . S Y="DICR("_DICR_",""ORG"")"
