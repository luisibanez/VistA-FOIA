DIE0 ;SFISC/GFT-BRANCHING, UP-ARROWING ;5:49 AM  21 Sep 2000
 ;;22.0;VA FileMan;**60**;Mar 30, 1999
...
X W:X'["?"&'$D(ZTQUEUED) $C(7),"??" G B^DIED:'$D(DB(DQ)),B^DIE1
 ;
BR ;
 S Y=U X DQ(0,DQ) D:$D(DIEFIRE)#2 FIREREC^DIE1 G A^DIED:$D(Y)[0,A^DIED:Y=U S D=$S(+Y=Y:9999,1:DQ),X="" I 0[Y S DQ=0 G OUT
