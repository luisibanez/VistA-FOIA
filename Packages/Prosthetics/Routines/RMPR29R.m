RMPR29R ;PHX/JLT,RVD-PRINT 2529-3 [ 10/01/94  5:39 AM ]
 ;;3.0;PROSTHETICS;**9,23,34**;Feb 09, 1996
...
PRT ;PRINT 2529-3 PASS RMPRDA
 ...
 S DIC=4,DIC(0)="QZN",X=$P(^RMPR(664.1,RMPRDA,0),U,15)
 D ^DIC G:+Y'>0 EXIT
 N RC
 S RMPRINS=+Y,RC=0
...
GETP ;GET CORRECT PRINTER FOR 2529-3
 N SRC,PNODE S SRC=$P($G(^RMPR(664.1,RMPRDA,0)),U,11),PNODE=$P($G(^RMPR(669.9,RMPRSITE,"DEV")),U,2,99)
 S X=$S(SRC="N"!(SRC="D"):$P($G(^RMPR(669.9,RMPRSITE,0)),U,5),SRC="O":$P(PNODE,U),SRC="R":$P(PNODE,U,2),SRC="S":$P(PNODE,U,3),SRC="W":$P(PNODE,U,4),1:"")
 ;see internal notes
