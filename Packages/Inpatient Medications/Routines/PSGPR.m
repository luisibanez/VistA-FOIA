...
PP0 ;
 ...
 I 'PSGPR,PSGSS'="P",'$D(^UTILITY("PSG",$J)) D READ^PSJUTL Q
 S (S1,S2,S3,X)=""
 F  S S1=$O(^UTILITY("PSG",$J,S1)) Q:S1=""  F  S S2=$O(^UTILITY("PSG",$J,S1,S2)) Q:S2=""  F  S S3=$O(^UTILITY("PSG",$J,S1,S2,S3)) Q:S3=""  D PP1
 D:X'["^"&PSGPR BOT^PSGO K ^UTILITY("PSG",$J) Q
 ;
PP1 ;
 ;* S PSGORD=$P(S3,"^",2)_S1 D EN2^PSGVW I PSGPRA'="N" S AT=PSGPRA D ENA^PSGVW0
 S PSGORD=$P(S3,"^",2)_$S(S1["B":"P",S1["C":"P",1:"U") D EN2^PSGVW I PSGPRA'="N" S AT=PSGPRA D ENA^PSGVW0
