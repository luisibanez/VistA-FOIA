SCRPPAT3 ;ALB/CMM - Practitioner's Patients ; 8/30/99 3:14pm
 ;;5.3;Scheduling;**41,52,148,174,181,177**;AUG 13, 1993
 ;
...
PAT(INS,SEC,TRD,SEC3,ST3,ST4,POS) ;
 ...
 ..I (IOST'?1"C-".E),$Y>(IOSL-5) D NEWP1^SCRPU3(.PAGE,TITL) D:'STOP HEAD2(INS,SEC,TRD,SEC3,ST3,ST4,POS) D:'FIRST&'STOP HEADER
 ..I (IOST?1"C-".E),$Y>(IOSL-5) D HOLD^SCRPU3(.PAGE,TITL) D:'STOP HEAD2(INS,SEC,TRD,SEC3,ST3,ST4,POS) D:'FIRST&'STOP HEADER
 ..Q:STOP
...
HEAD2(INS,SEC,TRD,SEC3,ST3,ST4,POS) ;
 ...
 .I $L($G(@STORE@("PN",INS,SEC,TRD,POS,"PRCP"))) W !,@STORE@("PN",INS,SEC,TRD,POS,"PRCP")
